...
type
  ...
  gsl_monte_miser_state* {.bycopy.} = object
    min_calls*: csize_t
  ...
  gsl_monte_miser_params* {.bycopy.} = object
    estimate_frac*: cdouble
    min_calls*: csize_t
    min_calls_per_bisection*: csize_t
    alpha*: cdouble
...
proc gsl_monte_miser_integrate*(f: ptr gsl_monte_function; xl: ptr cdouble; xh: ptr cdouble; dim: csize_t; calls: csize_t; r: ptr gsl_rng; state: ptr gsl_monte_miser_state; result: ptr cdouble; abserr: ptr cdouble): cint {.cdecl, importc: "gsl_monte_miser_integrate", dynlib: libgsl.}
proc gsl_monte_miser_alloc*(dim: csize_t): ptr gsl_monte_miser_state {.cdecl, importc: "gsl_monte_miser_alloc", dynlib: libgsl.}
proc gsl_monte_miser_init*(state: ptr gsl_monte_miser_state): cint {.cdecl, importc: "gsl_monte_miser_init", dynlib: libgsl.}
proc gsl_monte_miser_free*(state: ptr gsl_monte_miser_state) {.cdecl, importc: "gsl_monte_miser_free", dynlib: libgsl.}
proc gsl_monte_miser_params_get*(state: ptr gsl_monte_miser_state; params: ptr gsl_monte_miser_params) {.cdecl, importc: "gsl_monte_miser_params_get", dynlib: libgsl.}
proc gsl_monte_miser_params_set*(state: ptr gsl_monte_miser_state; params: ptr gsl_monte_miser_params) {.cdecl, importc: "gsl_monte_miser_params_set", dynlib: libgsl.}
