...
type
  ...
  gsl_multimin_function_struct* {.bycopy.} = object
    f*: proc (x: ptr gsl_vector; params: pointer): cdouble {.cdecl.}
    n*: csize_t
    params*: pointer

  gsl_multimin_function* = gsl_multimin_function_struct
  gsl_multimin_function_fdf_struct* {.bycopy.} = object
    f*: proc (x: ptr gsl_vector; params: pointer): cdouble {.cdecl.}
    df*: proc (x: ptr gsl_vector; params: pointer; df: ptr gsl_vector) {.cdecl.}
    fdf*: proc (x: ptr gsl_vector; params: pointer; f: ptr cdouble; df: ptr gsl_vector) {.     cdecl.}
    n*: csize_t
    params*: pointer

  gsl_multimin_function_fdf* = gsl_multimin_function_fdf_struct

  gsl_multimin_fminimizer_type* {.bycopy.} = object
    name*: cstring
    size*: csize_t
    alloc*: proc (state: pointer; n: csize_t): cint {.cdecl.}
    set*: proc (state: pointer; f: ptr gsl_multimin_function; x: ptr gsl_vector; size: ptr cdouble; step_size: ptr gsl_vector): cint {.cdecl.}
    iterate*: proc (state: pointer; f: ptr gsl_multimin_function; x: ptr gsl_vector; size: ptr cdouble; fval: ptr cdouble): cint {.cdecl.}
    free*: proc (state: pointer) {.cdecl.}

  gsl_multimin_fminimizer* {.bycopy.} = object
  ...
  gsl_multimin_fdfminimizer_type* {.bycopy.} = object
    name*: cstring
    size*: csize_t
    alloc*: proc (state: pointer; n: csize_t): cint {.cdecl.}
    set*: proc (state: pointer; fdf: ptr gsl_multimin_function_fdf; x: ptr gsl_vector; f: ptr cdouble; gradient: ptr gsl_vector; step_size: cdouble; tol: cdouble): cint {.     cdecl.}
    iterate*: proc (state: pointer; fdf: ptr gsl_multimin_function_fdf; x: ptr gsl_vector; f: ptr cdouble; gradient: ptr gsl_vector; dx: ptr gsl_vector): cint {.cdecl.}
    restart*: proc (state: pointer): cint {.cdecl.}
    free*: proc (state: pointer) {.cdecl.}

  gsl_multimin_fdfminimizer* {.bycopy.} = object
...
proc gsl_multimin_diff*(f: ptr gsl_multimin_function; x: ptr gsl_vector;   g: ptr gsl_vector): cint {.cdecl, importc: "gsl_multimin_diff", dynlib: libgsl.}
proc gsl_multimin_fminimizer_alloc*(T: ptr gsl_multimin_fminimizer_type; n: csize_t): ptr gsl_multimin_fminimizer {. cdecl, importc: "gsl_multimin_fminimizer_alloc", dynlib: libgsl.}
proc gsl_multimin_fminimizer_set*(s: ptr gsl_multimin_fminimizer; f: ptr gsl_multimin_function; x: ptr gsl_vector; step_size: ptr gsl_vector): cint {.cdecl, importc: "gsl_multimin_fminimizer_set", dynlib: libgsl.}
proc gsl_multimin_fminimizer_free*(s: ptr gsl_multimin_fminimizer) {.cdecl, importc: "gsl_multimin_fminimizer_free", dynlib: libgsl.}
proc gsl_multimin_fminimizer_name*(s: ptr gsl_multimin_fminimizer): cstring {.cdecl, importc: "gsl_multimin_fminimizer_name", dynlib: libgsl.}
proc gsl_multimin_fminimizer_iterate*(s: ptr gsl_multimin_fminimizer): cint {.cdecl, importc: "gsl_multimin_fminimizer_iterate", dynlib: libgsl.}
proc gsl_multimin_fminimizer_x*(s: ptr gsl_multimin_fminimizer): ptr gsl_vector {. cdecl, importc: "gsl_multimin_fminimizer_x", dynlib: libgsl.}
proc gsl_multimin_fminimizer_minimum*(s: ptr gsl_multimin_fminimizer): cdouble {. cdecl, importc: "gsl_multimin_fminimizer_minimum", dynlib: libgsl.}
proc gsl_multimin_fminimizer_size*(s: ptr gsl_multimin_fminimizer): cdouble {.cdecl, importc: "gsl_multimin_fminimizer_size", dynlib: libgsl.}
proc gsl_multimin_test_gradient*(g: ptr gsl_vector; epsabs: cdouble): cint {.cdecl, importc: "gsl_multimin_test_gradient", dynlib: libgsl.}
proc gsl_multimin_test_size*(size: cdouble; epsabs: cdouble): cint {.cdecl, importc: "gsl_multimin_test_size", dynlib: libgsl.}
proc gsl_multimin_fdfminimizer_alloc*(T: ptr gsl_multimin_fdfminimizer_type;  n: csize_t): ptr gsl_multimin_fdfminimizer {. cdecl, importc: "gsl_multimin_fdfminimizer_alloc", dynlib: libgsl.}
proc gsl_multimin_fdfminimizer_set*(s: ptr gsl_multimin_fdfminimizer;  fdf: ptr gsl_multimin_function_fdf;  x: ptr gsl_vector; step_size: cdouble;  tol: cdouble): cint {.cdecl, importc: "gsl_multimin_fdfminimizer_set", dynlib: libgsl.}
proc gsl_multimin_fdfminimizer_free*(s: ptr gsl_multimin_fdfminimizer) {.cdecl, importc: "gsl_multimin_fdfminimizer_free", dynlib: libgsl.}
proc gsl_multimin_fdfminimizer_name*(s: ptr gsl_multimin_fdfminimizer): cstring {. cdecl, importc: "gsl_multimin_fdfminimizer_name", dynlib: libgsl.}
proc gsl_multimin_fdfminimizer_iterate*(s: ptr gsl_multimin_fdfminimizer): cint {. cdecl, importc: "gsl_multimin_fdfminimizer_iterate", dynlib: libgsl.}
proc gsl_multimin_fdfminimizer_restart*(s: ptr gsl_multimin_fdfminimizer): cint {. cdecl, importc: "gsl_multimin_fdfminimizer_restart", dynlib: libgsl.}
proc gsl_multimin_fdfminimizer_x*(s: ptr gsl_multimin_fdfminimizer): ptr gsl_vector {. cdecl, importc: "gsl_multimin_fdfminimizer_x", dynlib: libgsl.}
proc gsl_multimin_fdfminimizer_dx*(s: ptr gsl_multimin_fdfminimizer): ptr gsl_vector {. cdecl, importc: "gsl_multimin_fdfminimizer_dx", dynlib: libgsl.}
proc gsl_multimin_fdfminimizer_gradient*(s: ptr gsl_multimin_fdfminimizer): ptr gsl_vector {. cdecl, importc: "gsl_multimin_fdfminimizer_gradient", dynlib: libgsl.}
proc gsl_multimin_fdfminimizer_minimum*(s: ptr gsl_multimin_fdfminimizer): cdouble {. cdecl, importc: "gsl_multimin_fdfminimizer_minimum", dynlib: libgsl.}
...
var gsl_multimin_fdfminimizer_steepest_descent*
    {.importc: "gsl_multimin_fdfminimizer_steepest_descent", dynlib: libgsl.}: ptr gsl_multimin_fdfminimizer_type

var gsl_multimin_fdfminimizer_conjugate_pr*
    {.importc: "gsl_multimin_fdfminimizer_conjugate_pr", dynlib: libgsl.}: ptr gsl_multimin_fdfminimizer_type

var gsl_multimin_fdfminimizer_conjugate_fr*
    {.importc: "gsl_multimin_fdfminimizer_conjugate_fr", dynlib: libgsl.}: ptr gsl_multimin_fdfminimizer_type

var gsl_multimin_fdfminimizer_vector_bfgs*
    {.importc: "gsl_multimin_fdfminimizer_vector_bfgs", dynlib: libgsl.}: ptr gsl_multimin_fdfminimizer_type

var gsl_multimin_fdfminimizer_vector_bfgs2*
    {.importc: "gsl_multimin_fdfminimizer_vector_bfgs2", dynlib: libgsl.}: ptr gsl_multimin_fdfminimizer_type

var gsl_multimin_fminimizer_nmsimplex* {.importc: "gsl_multimin_fminimizer_nmsimplex", dynlib: libgsl.}: ptr gsl_multimin_fminimizer_type

var gsl_multimin_fminimizer_nmsimplex2* {.importc: "gsl_multimin_fminimizer_nmsimplex2",  dynlib: libgsl.}: ptr gsl_multimin_fminimizer_type

var gsl_multimin_fminimizer_nmsimplex2rand*
    {.importc: "gsl_multimin_fminimizer_nmsimplex2rand", dynlib: libgsl.}: ptr gsl_multimin_fminimizer_type
