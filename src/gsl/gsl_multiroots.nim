...
type
  ...
  gsl_multiroot_function_struct* {.bycopy.} = object
  ...
  gsl_multiroot_fsolver_type* {.bycopy.} = object
    name*: cstring
    size*: csize_t
    alloc*: proc (state: pointer; n: csize_t): cint {.cdecl.}
    set*: proc (state: pointer; function: ptr gsl_multiroot_function; x: ptr gsl_vector; f: ptr gsl_vector; dx: ptr gsl_vector): cint {.cdecl.}
    iterate*: proc (state: pointer; function: ptr gsl_multiroot_function; x: ptr gsl_vector; f: ptr gsl_vector; dx: ptr gsl_vector): cint {.cdecl.}
    free*: proc (state: pointer) {.cdecl.}

  gsl_multiroot_fsolver* {.bycopy.} = object
    `type`*: ptr gsl_multiroot_fsolver_type
    function*: ptr gsl_multiroot_function
    x*: ptr gsl_vector
    f*: ptr gsl_vector
    dx*: ptr gsl_vector
    state*: pointer

  gsl_multiroot_function_fdf_struct* {.bycopy.} = object
    f*: proc (x: ptr gsl_vector; params: pointer; f: ptr gsl_vector): cint {.cdecl.}
  ...
  gsl_multiroot_fdfsolver_type* {.bycopy.} = object
    name*: cstring
    size*: csize_t
    alloc*: proc (state: pointer; n: csize_t): cint {.cdecl.}
    set*: proc (state: pointer; fdf: ptr gsl_multiroot_function_fdf; x: ptr gsl_vector; f: ptr gsl_vector; J: ptr gsl_matrix; dx: ptr gsl_vector): cint {.cdecl.}
    iterate*: proc (state: pointer; fdf: ptr gsl_multiroot_function_fdf; x: ptr gsl_vector; f: ptr gsl_vector; J: ptr gsl_matrix; dx: ptr gsl_vector): cint {.cdecl.}
    free*: proc (state: pointer) {.cdecl.}

  gsl_multiroot_fdfsolver* {.bycopy.} = object
...
proc gsl_multiroot_fdjacobian*(F: ptr gsl_multiroot_function; x: ptr gsl_vector;   f: ptr gsl_vector; epsrel: cdouble;   jacobian: ptr gsl_matrix): cint {.cdecl, importc: "gsl_multiroot_fdjacobian", dynlib: libgsl.}
proc gsl_multiroot_fsolver_alloc*(T: ptr gsl_multiroot_fsolver_type; n: csize_t): ptr gsl_multiroot_fsolver {. cdecl, importc: "gsl_multiroot_fsolver_alloc", dynlib: libgsl.}
proc gsl_multiroot_fsolver_free*(s: ptr gsl_multiroot_fsolver) {.cdecl, importc: "gsl_multiroot_fsolver_free", dynlib: libgsl.}
proc gsl_multiroot_fsolver_set*(s: ptr gsl_multiroot_fsolver; f: ptr gsl_multiroot_function; x: ptr gsl_vector): cint {. cdecl, importc: "gsl_multiroot_fsolver_set", dynlib: libgsl.}
proc gsl_multiroot_fsolver_iterate*(s: ptr gsl_multiroot_fsolver): cint {.cdecl, importc: "gsl_multiroot_fsolver_iterate", dynlib: libgsl.}
proc gsl_multiroot_fsolver_name*(s: ptr gsl_multiroot_fsolver): cstring {.cdecl, importc: "gsl_multiroot_fsolver_name", dynlib: libgsl.}
proc gsl_multiroot_fsolver_root*(s: ptr gsl_multiroot_fsolver): ptr gsl_vector {. cdecl, importc: "gsl_multiroot_fsolver_root", dynlib: libgsl.}
proc gsl_multiroot_fsolver_dx*(s: ptr gsl_multiroot_fsolver): ptr gsl_vector {.cdecl, importc: "gsl_multiroot_fsolver_dx", dynlib: libgsl.}
proc gsl_multiroot_fsolver_f*(s: ptr gsl_multiroot_fsolver): ptr gsl_vector {.cdecl, importc: "gsl_multiroot_fsolver_f", dynlib: libgsl.}
proc gsl_multiroot_fdfsolver_alloc*(T: ptr gsl_multiroot_fdfsolver_type; n: csize_t): ptr gsl_multiroot_fdfsolver {. cdecl, importc: "gsl_multiroot_fdfsolver_alloc", dynlib: libgsl.}
proc gsl_multiroot_fdfsolver_set*(s: ptr gsl_multiroot_fdfsolver; fdf: ptr gsl_multiroot_function_fdf; x: ptr gsl_vector): cint {.cdecl, importc: "gsl_multiroot_fdfsolver_set", dynlib: libgsl.}
proc gsl_multiroot_fdfsolver_iterate*(s: ptr gsl_multiroot_fdfsolver): cint {.cdecl, importc: "gsl_multiroot_fdfsolver_iterate", dynlib: libgsl.}
proc gsl_multiroot_fdfsolver_free*(s: ptr gsl_multiroot_fdfsolver) {.cdecl, importc: "gsl_multiroot_fdfsolver_free", dynlib: libgsl.}
proc gsl_multiroot_fdfsolver_name*(s: ptr gsl_multiroot_fdfsolver): cstring {.cdecl, importc: "gsl_multiroot_fdfsolver_name", dynlib: libgsl.}
proc gsl_multiroot_fdfsolver_root*(s: ptr gsl_multiroot_fdfsolver): ptr gsl_vector {. cdecl, importc: "gsl_multiroot_fdfsolver_root", dynlib: libgsl.}
proc gsl_multiroot_fdfsolver_dx*(s: ptr gsl_multiroot_fdfsolver): ptr gsl_vector {. cdecl, importc: "gsl_multiroot_fdfsolver_dx", dynlib: libgsl.}
proc gsl_multiroot_fdfsolver_f*(s: ptr gsl_multiroot_fdfsolver): ptr gsl_vector {. cdecl, importc: "gsl_multiroot_fdfsolver_f", dynlib: libgsl.}
proc gsl_multiroot_test_delta*(dx: ptr gsl_vector; x: ptr gsl_vector; epsabs: cdouble;   epsrel: cdouble): cint {.cdecl, importc: "gsl_multiroot_test_delta", dynlib: libgsl.}
proc gsl_multiroot_test_residual*(f: ptr gsl_vector; epsabs: cdouble): cint {.cdecl, importc: "gsl_multiroot_test_residual", dynlib: libgsl.}
...
var gsl_multiroot_fsolver_dnewton* {.importc: "gsl_multiroot_fsolver_dnewton",  dynlib: libgsl.}: ptr gsl_multiroot_fsolver_type

var gsl_multiroot_fsolver_broyden* {.importc: "gsl_multiroot_fsolver_broyden",  dynlib: libgsl.}: ptr gsl_multiroot_fsolver_type

var gsl_multiroot_fsolver_hybrid* {.importc: "gsl_multiroot_fsolver_hybrid", dynlib: libgsl.}: ptr gsl_multiroot_fsolver_type

var gsl_multiroot_fsolver_hybrids* {.importc: "gsl_multiroot_fsolver_hybrids",  dynlib: libgsl.}: ptr gsl_multiroot_fsolver_type

var gsl_multiroot_fdfsolver_newton* {.importc: "gsl_multiroot_fdfsolver_newton", dynlib: libgsl.}: ptr gsl_multiroot_fdfsolver_type

var gsl_multiroot_fdfsolver_gnewton* {.importc: "gsl_multiroot_fdfsolver_gnewton",  dynlib: libgsl.}: ptr gsl_multiroot_fdfsolver_type

var gsl_multiroot_fdfsolver_hybridj* {.importc: "gsl_multiroot_fdfsolver_hybridj",  dynlib: libgsl.}: ptr gsl_multiroot_fdfsolver_type

var gsl_multiroot_fdfsolver_hybridsj* {.importc: "gsl_multiroot_fdfsolver_hybridsj",   dynlib: libgsl.}: ptr gsl_multiroot_fdfsolver_type
