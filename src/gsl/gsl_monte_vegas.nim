...
type
  ...
  gsl_monte_vegas_state* {.bycopy.} = object
    dim*: csize_t
    bins_max*: csize_t
    bins*: cuint
    boxes*: cuint
  ...
  gsl_monte_vegas_params* {.bycopy.} = object
    alpha*: cdouble
    iterations*: csize_t
    stage*: cint
    mode*: cint
...
proc gsl_monte_vegas_integrate*(f: ptr gsl_monte_function; xl: ptr cdouble; xu: ptr cdouble; dim: csize_t; calls: csize_t; r: ptr gsl_rng; state: ptr gsl_monte_vegas_state; result: ptr cdouble; abserr: ptr cdouble): cint {.cdecl, importc: "gsl_monte_vegas_integrate", dynlib: libgsl.}
proc gsl_monte_vegas_alloc*(dim: csize_t): ptr gsl_monte_vegas_state {.cdecl, importc: "gsl_monte_vegas_alloc", dynlib: libgsl.}
proc gsl_monte_vegas_init*(state: ptr gsl_monte_vegas_state): cint {.cdecl, importc: "gsl_monte_vegas_init", dynlib: libgsl.}
proc gsl_monte_vegas_free*(state: ptr gsl_monte_vegas_state) {.cdecl, importc: "gsl_monte_vegas_free", dynlib: libgsl.}
proc gsl_monte_vegas_chisq*(state: ptr gsl_monte_vegas_state): cdouble {.cdecl, importc: "gsl_monte_vegas_chisq", dynlib: libgsl.}
proc gsl_monte_vegas_runval*(state: ptr gsl_monte_vegas_state; result: ptr cdouble; sigma: ptr cdouble) {.cdecl, importc: "gsl_monte_vegas_runval", dynlib: libgsl.}
proc gsl_monte_vegas_params_get*(state: ptr gsl_monte_vegas_state; params: ptr gsl_monte_vegas_params) {.cdecl, importc: "gsl_monte_vegas_params_get", dynlib: libgsl.}
proc gsl_monte_vegas_params_set*(state: ptr gsl_monte_vegas_state; params: ptr gsl_monte_vegas_params) {.cdecl, importc: "gsl_monte_vegas_params_set", dynlib: libgsl.}
