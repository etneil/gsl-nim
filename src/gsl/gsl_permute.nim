...
proc gsl_permute_complex*(p: ptr csize_t; data: ptr cdouble; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_permute_complex", dynlib: libgsl.}
proc gsl_permute_complex_inverse*(p: ptr csize_t; data: ptr cdouble; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_permute_complex_inverse", dynlib: libgsl.}
proc gsl_permute_complex_float*(p: ptr csize_t; data: ptr cfloat; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_permute_complex_float", dynlib: libgsl.}
proc gsl_permute_complex_float_inverse*(p: ptr csize_t; data: ptr cfloat;    stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_permute_complex_float_inverse", dynlib: libgsl.}
proc gsl_permute_long_double*(p: ptr csize_t; data: ptr clongdouble; stride: csize_t;  n: csize_t): cint {.cdecl, importc: "gsl_permute_long_double", dynlib: libgsl.}
proc gsl_permute_long_double_inverse*(p: ptr csize_t; data: ptr clongdouble;  stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_permute_long_double_inverse", dynlib: libgsl.}
proc gsl_permute*(p: ptr csize_t; data: ptr cdouble; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_permute", dynlib: libgsl.}
proc gsl_permute_inverse*(p: ptr csize_t; data: ptr cdouble; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_permute_inverse", dynlib: libgsl.}
proc gsl_permute_float*(p: ptr csize_t; data: ptr cfloat; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_permute_float", dynlib: libgsl.}
proc gsl_permute_float_inverse*(p: ptr csize_t; data: ptr cfloat; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_permute_float_inverse", dynlib: libgsl.}
proc gsl_permute_ulong*(p: ptr csize_t; data: ptr culong; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_permute_ulong", dynlib: libgsl.}
proc gsl_permute_ulong_inverse*(p: ptr csize_t; data: ptr culong; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_permute_ulong_inverse", dynlib: libgsl.}
proc gsl_permute_long*(p: ptr csize_t; data: ptr clong; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_permute_long", dynlib: libgsl.}
proc gsl_permute_long_inverse*(p: ptr csize_t; data: ptr clong; stride: csize_t;   n: csize_t): cint {.cdecl, importc: "gsl_permute_long_inverse", dynlib: libgsl.}
proc gsl_permute_uint*(p: ptr csize_t; data: ptr cuint; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_permute_uint", dynlib: libgsl.}
proc gsl_permute_uint_inverse*(p: ptr csize_t; data: ptr cuint; stride: csize_t;   n: csize_t): cint {.cdecl, importc: "gsl_permute_uint_inverse", dynlib: libgsl.}
proc gsl_permute_int*(p: ptr csize_t; data: ptr cint; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_permute_int", dynlib: libgsl.}
proc gsl_permute_int_inverse*(p: ptr csize_t; data: ptr cint; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_permute_int_inverse", dynlib: libgsl.}
proc gsl_permute_ushort*(p: ptr csize_t; data: ptr cushort; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_permute_ushort", dynlib: libgsl.}
proc gsl_permute_ushort_inverse*(p: ptr csize_t; data: ptr cushort; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_permute_ushort_inverse", dynlib: libgsl.}
proc gsl_permute_short*(p: ptr csize_t; data: ptr cshort; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_permute_short", dynlib: libgsl.}
proc gsl_permute_short_inverse*(p: ptr csize_t; data: ptr cshort; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_permute_short_inverse", dynlib: libgsl.}
proc gsl_permute_uchar*(p: ptr csize_t; data: ptr cuchar; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_permute_uchar", dynlib: libgsl.}
proc gsl_permute_uchar_inverse*(p: ptr csize_t; data: ptr cuchar; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_permute_uchar_inverse", dynlib: libgsl.}
proc gsl_permute_char*(p: ptr csize_t; data: cstring; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_permute_char", dynlib: libgsl.}
proc gsl_permute_char_inverse*(p: ptr csize_t; data: cstring; stride: csize_t;   n: csize_t): cint {.cdecl, importc: "gsl_permute_char_inverse", dynlib: libgsl.}
