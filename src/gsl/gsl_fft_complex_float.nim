...
type
  ...
  gsl_fft_complex_wavetable_float* {.bycopy.} = object
    n*: csize_t
    nf*: csize_t
  ...
  gsl_fft_complex_workspace_float* {.bycopy.} = object
    n*: csize_t
    scratch*: ptr cfloat
...
proc gsl_fft_complex_float_radix2_forward*(data: gsl_complex_packed_array_float; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_complex_float_radix2_forward", dynlib: libgsl.}
proc gsl_fft_complex_float_radix2_backward*(data: gsl_complex_packed_array_float; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_complex_float_radix2_backward", dynlib: libgsl.}
proc gsl_fft_complex_float_radix2_inverse*(data: gsl_complex_packed_array_float; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_complex_float_radix2_inverse", dynlib: libgsl.}
proc gsl_fft_complex_float_radix2_transform*(data: gsl_complex_packed_array_float; stride: csize_t; n: csize_t; sign: gsl_fft_direction): cint {.cdecl, importc: "gsl_fft_complex_float_radix2_transform", dynlib: libgsl.}
proc gsl_fft_complex_float_radix2_dif_forward*(data: gsl_complex_packed_array_float; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_complex_float_radix2_dif_forward", dynlib: libgsl.}
proc gsl_fft_complex_float_radix2_dif_backward*(data: gsl_complex_packed_array_float; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_complex_float_radix2_dif_backward", dynlib: libgsl.}
proc gsl_fft_complex_float_radix2_dif_inverse*(data: gsl_complex_packed_array_float; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_complex_float_radix2_dif_inverse", dynlib: libgsl.}
proc gsl_fft_complex_float_radix2_dif_transform*(data: gsl_complex_packed_array_float; stride: csize_t; n: csize_t; sign: gsl_fft_direction): cint {.cdecl, importc: "gsl_fft_complex_float_radix2_dif_transform", dynlib: libgsl.}
proc gsl_fft_complex_wavetable_float_alloc*(n: csize_t): ptr gsl_fft_complex_wavetable_float {. cdecl, importc: "gsl_fft_complex_wavetable_float_alloc", dynlib: libgsl.}
proc gsl_fft_complex_wavetable_float_free*(wavetable: ptr gsl_fft_complex_wavetable_float) {.cdecl, importc: "gsl_fft_complex_wavetable_float_free", dynlib: libgsl.}
proc gsl_fft_complex_workspace_float_alloc*(n: csize_t): ptr gsl_fft_complex_workspace_float {. cdecl, importc: "gsl_fft_complex_workspace_float_alloc", dynlib: libgsl.}
proc gsl_fft_complex_workspace_float_free*(workspace: ptr gsl_fft_complex_workspace_float) {.cdecl, importc: "gsl_fft_complex_workspace_float_free", dynlib: libgsl.}
proc gsl_fft_complex_float_memcpy*(dest: ptr gsl_fft_complex_wavetable_float; src: ptr gsl_fft_complex_wavetable_float): cint {. cdecl, importc: "gsl_fft_complex_float_memcpy", dynlib: libgsl.}
proc gsl_fft_complex_float_forward*(data: gsl_complex_packed_array_float;  stride: csize_t; n: csize_t; wavetable: ptr gsl_fft_complex_wavetable_float;  work: ptr gsl_fft_complex_workspace_float): cint {. cdecl, importc: "gsl_fft_complex_float_forward", dynlib: libgsl.}
proc gsl_fft_complex_float_backward*(data: gsl_complex_packed_array_float; stride: csize_t; n: csize_t; wavetable: ptr gsl_fft_complex_wavetable_float; work: ptr gsl_fft_complex_workspace_float): cint {. cdecl, importc: "gsl_fft_complex_float_backward", dynlib: libgsl.}
proc gsl_fft_complex_float_inverse*(data: gsl_complex_packed_array_float;  stride: csize_t; n: csize_t; wavetable: ptr gsl_fft_complex_wavetable_float;  work: ptr gsl_fft_complex_workspace_float): cint {. cdecl, importc: "gsl_fft_complex_float_inverse", dynlib: libgsl.}
proc gsl_fft_complex_float_transform*(data: gsl_complex_packed_array_float;  stride: csize_t; n: csize_t; wavetable: ptr gsl_fft_complex_wavetable_float;  work: ptr gsl_fft_complex_workspace_float;  sign: gsl_fft_direction): cint {.cdecl, importc: "gsl_fft_complex_float_transform", dynlib: libgsl.}
