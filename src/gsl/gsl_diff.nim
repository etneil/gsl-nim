...
proc gsl_diff_central*(f: ptr gsl_function; x: cdouble; result: ptr cdouble;  abserr: ptr cdouble): cint {.cdecl, importc: "gsl_diff_central", dynlib: libgsl.}
proc gsl_diff_backward*(f: ptr gsl_function; x: cdouble; result: ptr cdouble;   abserr: ptr cdouble): cint {.cdecl, importc: "gsl_diff_backward", dynlib: libgsl.}
proc gsl_diff_forward*(f: ptr gsl_function; x: cdouble; result: ptr cdouble;  abserr: ptr cdouble): cint {.cdecl, importc: "gsl_diff_forward", dynlib: libgsl.}
