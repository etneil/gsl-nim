...
type
  ...
  gsl_multifit_linear_workspace* {.bycopy.} = object
    nmax*: csize_t
    pmax*: csize_t
    n*: csize_t
    p*: csize_t
  ...
  gsl_multifit_robust_type* {.bycopy.} = object
    name*: cstring
    wfun*: proc (r: ptr gsl_vector; w: ptr gsl_vector): cint {.cdecl.}
    psi_deriv*: proc (r: ptr gsl_vector; dpsi: ptr gsl_vector): cint {.cdecl.}
    tuning_default*: cdouble

  gsl_multifit_robust_stats* {.bycopy.} = object
    sigma_ols*: cdouble
    sigma_mad*: cdouble
    sigma_rob*: cdouble
    sigma*: cdouble
  ...
  gsl_multifit_robust_workspace* {.bycopy.} = object
    n*: csize_t
    p*: csize_t
    numit*: csize_t
    maxiter*: csize_t
...
proc gsl_multifit_linear_alloc*(n: csize_t; p: csize_t): ptr gsl_multifit_linear_workspace {. cdecl, importc: "gsl_multifit_linear_alloc", dynlib: libgsl.}
proc gsl_multifit_linear_free*(w: ptr gsl_multifit_linear_workspace) {.cdecl, importc: "gsl_multifit_linear_free", dynlib: libgsl.}
proc gsl_multifit_linear*(X: ptr gsl_matrix; y: ptr gsl_vector; c: ptr gsl_vector; cov: ptr gsl_matrix; chisq: ptr cdouble; work: ptr gsl_multifit_linear_workspace): cint {.cdecl, importc: "gsl_multifit_linear", dynlib: libgsl.}
proc gsl_multifit_linear_tsvd*(X: ptr gsl_matrix; y: ptr gsl_vector; tol: cdouble;   c: ptr gsl_vector; cov: ptr gsl_matrix;   chisq: ptr cdouble; rank: ptr csize_t;   work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_tsvd", dynlib: libgsl.}
proc gsl_multifit_linear_svd*(X: ptr gsl_matrix;  work: ptr gsl_multifit_linear_workspace): cint {.cdecl, importc: "gsl_multifit_linear_svd", dynlib: libgsl.}
proc gsl_multifit_linear_bsvd*(X: ptr gsl_matrix;   work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_bsvd", dynlib: libgsl.}
proc gsl_multifit_linear_rank*(tol: cdouble;   work: ptr gsl_multifit_linear_workspace): csize_t {. cdecl, importc: "gsl_multifit_linear_rank", dynlib: libgsl.}
proc gsl_multifit_linear_solve*(lambda: cdouble; X: ptr gsl_matrix; y: ptr gsl_vector; c: ptr gsl_vector; rnorm: ptr cdouble; snorm: ptr cdouble; work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_solve", dynlib: libgsl.}
proc gsl_multifit_linear_applyW*(X: ptr gsl_matrix; w: ptr gsl_vector; y: ptr gsl_vector; WX: ptr gsl_matrix; Wy: ptr gsl_vector): cint {.cdecl, importc: "gsl_multifit_linear_applyW", dynlib: libgsl.}
proc gsl_multifit_linear_stdform1*(L: ptr gsl_vector; X: ptr gsl_matrix; y: ptr gsl_vector; Xs: ptr gsl_matrix; ys: ptr gsl_vector; work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_stdform1", dynlib: libgsl.}
proc gsl_multifit_linear_wstdform1*(L: ptr gsl_vector; X: ptr gsl_matrix;  w: ptr gsl_vector; y: ptr gsl_vector;  Xs: ptr gsl_matrix; ys: ptr gsl_vector;  work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_wstdform1", dynlib: libgsl.}
proc gsl_multifit_linear_L_decomp*(L: ptr gsl_matrix; tau: ptr gsl_vector): cint {. cdecl, importc: "gsl_multifit_linear_L_decomp", dynlib: libgsl.}
proc gsl_multifit_linear_stdform2*(LQR: ptr gsl_matrix; Ltau: ptr gsl_vector; X: ptr gsl_matrix; y: ptr gsl_vector; Xs: ptr gsl_matrix; ys: ptr gsl_vector; M: ptr gsl_matrix; work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_stdform2", dynlib: libgsl.}
proc gsl_multifit_linear_wstdform2*(LQR: ptr gsl_matrix; Ltau: ptr gsl_vector;  X: ptr gsl_matrix; w: ptr gsl_vector;  y: ptr gsl_vector; Xs: ptr gsl_matrix;  ys: ptr gsl_vector; M: ptr gsl_matrix;  work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_wstdform2", dynlib: libgsl.}
proc gsl_multifit_linear_genform1*(L: ptr gsl_vector; cs: ptr gsl_vector; c: ptr gsl_vector; work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_genform1", dynlib: libgsl.}
proc gsl_multifit_linear_genform2*(LQR: ptr gsl_matrix; Ltau: ptr gsl_vector; X: ptr gsl_matrix; y: ptr gsl_vector; cs: ptr gsl_vector; M: ptr gsl_matrix; c: ptr gsl_vector; work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_genform2", dynlib: libgsl.}
proc gsl_multifit_linear_wgenform2*(LQR: ptr gsl_matrix; Ltau: ptr gsl_vector;  X: ptr gsl_matrix; w: ptr gsl_vector;  y: ptr gsl_vector; cs: ptr gsl_vector;  M: ptr gsl_matrix; c: ptr gsl_vector;  work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_wgenform2", dynlib: libgsl.}
proc gsl_multifit_linear_lreg*(smin: cdouble; smax: cdouble;   reg_param: ptr gsl_vector): cint {.cdecl, importc: "gsl_multifit_linear_lreg", dynlib: libgsl.}
proc gsl_multifit_linear_lcurve*(y: ptr gsl_vector; reg_param: ptr gsl_vector; rho: ptr gsl_vector; eta: ptr gsl_vector; work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_lcurve", dynlib: libgsl.}
proc gsl_multifit_linear_lcorner*(rho: ptr gsl_vector; eta: ptr gsl_vector; idx: ptr csize_t): cint {.cdecl, importc: "gsl_multifit_linear_lcorner", dynlib: libgsl.}
proc gsl_multifit_linear_lcorner2*(reg_param: ptr gsl_vector; eta: ptr gsl_vector; idx: ptr csize_t): cint {.cdecl, importc: "gsl_multifit_linear_lcorner2", dynlib: libgsl.}
proc gsl_multifit_linear_Lk*(p: csize_t; k: csize_t; L: ptr gsl_matrix): cint {.cdecl, importc: "gsl_multifit_linear_Lk", dynlib: libgsl.}
proc gsl_multifit_linear_Lsobolev*(p: csize_t; kmax: csize_t; alpha: ptr gsl_vector; L: ptr gsl_matrix; work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_Lsobolev", dynlib: libgsl.}
proc gsl_multifit_wlinear*(X: ptr gsl_matrix; w: ptr gsl_vector; y: ptr gsl_vector;  c: ptr gsl_vector; cov: ptr gsl_matrix; chisq: ptr cdouble;  work: ptr gsl_multifit_linear_workspace): cint {.cdecl, importc: "gsl_multifit_wlinear", dynlib: libgsl.}
proc gsl_multifit_wlinear_tsvd*(X: ptr gsl_matrix; w: ptr gsl_vector; y: ptr gsl_vector; tol: cdouble; c: ptr gsl_vector; cov: ptr gsl_matrix; chisq: ptr cdouble; rank: ptr csize_t; work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_wlinear_tsvd", dynlib: libgsl.}
proc gsl_multifit_wlinear_svd*(X: ptr gsl_matrix; w: ptr gsl_vector; y: ptr gsl_vector;   tol: cdouble; rank: ptr csize_t; c: ptr gsl_vector;   cov: ptr gsl_matrix; chisq: ptr cdouble;   work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_wlinear_svd", dynlib: libgsl.}
proc gsl_multifit_wlinear_usvd*(X: ptr gsl_matrix; w: ptr gsl_vector; y: ptr gsl_vector; tol: cdouble; rank: ptr csize_t; c: ptr gsl_vector; cov: ptr gsl_matrix; chisq: ptr cdouble; work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_wlinear_usvd", dynlib: libgsl.}
proc gsl_multifit_linear_est*(x: ptr gsl_vector; c: ptr gsl_vector;  cov: ptr gsl_matrix; y: ptr cdouble; y_err: ptr cdouble): cint {. cdecl, importc: "gsl_multifit_linear_est", dynlib: libgsl.}
proc gsl_multifit_linear_rcond*(w: ptr gsl_multifit_linear_workspace): cdouble {. cdecl, importc: "gsl_multifit_linear_rcond", dynlib: libgsl.}
proc gsl_multifit_linear_residuals*(X: ptr gsl_matrix; y: ptr gsl_vector;  c: ptr gsl_vector; r: ptr gsl_vector): cint {.cdecl, importc: "gsl_multifit_linear_residuals", dynlib: libgsl.}
proc gsl_multifit_linear_gcv_init*(y: ptr gsl_vector; reg_param: ptr gsl_vector; UTy: ptr gsl_vector; delta0: ptr cdouble; work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_gcv_init", dynlib: libgsl.}
proc gsl_multifit_linear_gcv_curve*(reg_param: ptr gsl_vector; UTy: ptr gsl_vector;  delta0: cdouble; G: ptr gsl_vector;  work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_gcv_curve", dynlib: libgsl.}
proc gsl_multifit_linear_gcv_min*(reg_param: ptr gsl_vector; UTy: ptr gsl_vector; G: ptr gsl_vector; delta0: cdouble; lambda: ptr cdouble; work: ptr gsl_multifit_linear_workspace): cint {. cdecl, importc: "gsl_multifit_linear_gcv_min", dynlib: libgsl.}
proc gsl_multifit_linear_gcv_calc*(lambda: cdouble; UTy: ptr gsl_vector; delta0: cdouble; work: ptr gsl_multifit_linear_workspace): cdouble {. cdecl, importc: "gsl_multifit_linear_gcv_calc", dynlib: libgsl.}
proc gsl_multifit_linear_gcv*(y: ptr gsl_vector; reg_param: ptr gsl_vector;  G: ptr gsl_vector; lambda: ptr cdouble;  G_lambda: ptr cdouble;  work: ptr gsl_multifit_linear_workspace): cint {.cdecl, importc: "gsl_multifit_linear_gcv", dynlib: libgsl.}
proc gsl_multifit_robust_alloc*(T: ptr gsl_multifit_robust_type; n: csize_t; p: csize_t): ptr gsl_multifit_robust_workspace {. cdecl, importc: "gsl_multifit_robust_alloc", dynlib: libgsl.}
proc gsl_multifit_robust_free*(w: ptr gsl_multifit_robust_workspace) {.cdecl, importc: "gsl_multifit_robust_free", dynlib: libgsl.}
proc gsl_multifit_robust_tune*(tune: cdouble; w: ptr gsl_multifit_robust_workspace): cint {. cdecl, importc: "gsl_multifit_robust_tune", dynlib: libgsl.}
proc gsl_multifit_robust_maxiter*(maxiter: csize_t; w: ptr gsl_multifit_robust_workspace): cint {. cdecl, importc: "gsl_multifit_robust_maxiter", dynlib: libgsl.}
proc gsl_multifit_robust_name*(w: ptr gsl_multifit_robust_workspace): cstring {. cdecl, importc: "gsl_multifit_robust_name", dynlib: libgsl.}
proc gsl_multifit_robust_statistics*(w: ptr gsl_multifit_robust_workspace): gsl_multifit_robust_stats {. cdecl, importc: "gsl_multifit_robust_statistics", dynlib: libgsl.}
proc gsl_multifit_robust_weights*(r: ptr gsl_vector; wts: ptr gsl_vector; w: ptr gsl_multifit_robust_workspace): cint {. cdecl, importc: "gsl_multifit_robust_weights", dynlib: libgsl.}
proc gsl_multifit_robust*(X: ptr gsl_matrix; y: ptr gsl_vector; c: ptr gsl_vector; cov: ptr gsl_matrix; w: ptr gsl_multifit_robust_workspace): cint {. cdecl, importc: "gsl_multifit_robust", dynlib: libgsl.}
proc gsl_multifit_robust_est*(x: ptr gsl_vector; c: ptr gsl_vector;  cov: ptr gsl_matrix; y: ptr cdouble; y_err: ptr cdouble): cint {. cdecl, importc: "gsl_multifit_robust_est", dynlib: libgsl.}
proc gsl_multifit_robust_residuals*(X: ptr gsl_matrix; y: ptr gsl_vector;  c: ptr gsl_vector; r: ptr gsl_vector;  w: ptr gsl_multifit_robust_workspace): cint {. cdecl, importc: "gsl_multifit_robust_residuals", dynlib: libgsl.}
...
var gsl_multifit_robust_default* {.importc: "gsl_multifit_robust_default",   dynlib: libgsl.}: ptr gsl_multifit_robust_type

var gsl_multifit_robust_bisquare* {.importc: "gsl_multifit_robust_bisquare", dynlib: libgsl.}: ptr gsl_multifit_robust_type

var gsl_multifit_robust_cauchy* {.importc: "gsl_multifit_robust_cauchy",  dynlib: libgsl.}: ptr gsl_multifit_robust_type

var gsl_multifit_robust_fair* {.importc: "gsl_multifit_robust_fair", dynlib: libgsl.}: ptr gsl_multifit_robust_type

var gsl_multifit_robust_huber* {.importc: "gsl_multifit_robust_huber", dynlib: libgsl.}: ptr gsl_multifit_robust_type

var gsl_multifit_robust_ols* {.importc: "gsl_multifit_robust_ols", dynlib: libgsl.}: ptr gsl_multifit_robust_type

var gsl_multifit_robust_welsch* {.importc: "gsl_multifit_robust_welsch",  dynlib: libgsl.}: ptr gsl_multifit_robust_type
