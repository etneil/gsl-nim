...
type
  ...
  gsl_filter_end_t* {.size: sizeof(cint).} = enum
    GSL_FILTER_END_PADZERO = GSL_MOVSTAT_END_PADZERO, GSL_FILTER_END_PADVALUE = GSL_MOVSTAT_END_PADVALUE, GSL_FILTER_END_TRUNCATE = GSL_MOVSTAT_END_TRUNCATE
  gsl_filter_scale_t* {.size: sizeof(cint).} = enum
    GSL_FILTER_SCALE_MAD, GSL_FILTER_SCALE_IQR, GSL_FILTER_SCALE_SN, GSL_FILTER_SCALE_QN
  gsl_filter_gaussian_workspace* {.bycopy.} = object
    K*: csize_t
    kernel*: ptr cdouble
    movstat_workspace_p*: ptr gsl_movstat_workspace

  gsl_filter_median_workspace* {.bycopy.} = object
    movstat_workspace_p*: ptr gsl_movstat_workspace

  gsl_filter_rmedian_workspace* {.bycopy.} = object
    H*: csize_t
    K*: csize_t
    state*: pointer
    window*: ptr cdouble
  ...
  gsl_filter_impulse_workspace* {.bycopy.} = object
    movstat_workspace_p*: ptr gsl_movstat_workspace
...
proc gsl_filter_gaussian_alloc*(K: csize_t): ptr gsl_filter_gaussian_workspace {. cdecl, importc: "gsl_filter_gaussian_alloc", dynlib: libgsl.}
proc gsl_filter_gaussian_free*(w: ptr gsl_filter_gaussian_workspace) {.cdecl, importc: "gsl_filter_gaussian_free", dynlib: libgsl.}
proc gsl_filter_gaussian*(endtype: gsl_filter_end_t; alpha: cdouble; order: csize_t; x: ptr gsl_vector; y: ptr gsl_vector; w: ptr gsl_filter_gaussian_workspace): cint {.cdecl, importc: "gsl_filter_gaussian", dynlib: libgsl.}
proc gsl_filter_gaussian_kernel*(alpha: cdouble; order: csize_t; normalize: cint; kernel: ptr gsl_vector): cint {.cdecl, importc: "gsl_filter_gaussian_kernel", dynlib: libgsl.}
proc gsl_filter_median_alloc*(K: csize_t): ptr gsl_filter_median_workspace {.cdecl, importc: "gsl_filter_median_alloc", dynlib: libgsl.}
proc gsl_filter_median_free*(w: ptr gsl_filter_median_workspace) {.cdecl, importc: "gsl_filter_median_free", dynlib: libgsl.}
proc gsl_filter_median*(endtype: gsl_filter_end_t; x: ptr gsl_vector;   y: ptr gsl_vector; w: ptr gsl_filter_median_workspace): cint {. cdecl, importc: "gsl_filter_median", dynlib: libgsl.}
proc gsl_filter_rmedian_alloc*(K: csize_t): ptr gsl_filter_rmedian_workspace {.cdecl, importc: "gsl_filter_rmedian_alloc", dynlib: libgsl.}
proc gsl_filter_rmedian_free*(w: ptr gsl_filter_rmedian_workspace) {.cdecl, importc: "gsl_filter_rmedian_free", dynlib: libgsl.}
proc gsl_filter_rmedian*(a1: gsl_filter_end_t; x: ptr gsl_vector; y: ptr gsl_vector;    w: ptr gsl_filter_rmedian_workspace): cint {.cdecl, importc: "gsl_filter_rmedian", dynlib: libgsl.}
proc gsl_filter_rmedian2*(x: ptr gsl_vector; y: ptr gsl_vector; w: ptr gsl_filter_rmedian_workspace): cint {.cdecl, importc: "gsl_filter_rmedian2", dynlib: libgsl.}
proc gsl_filter_impulse_alloc*(K: csize_t): ptr gsl_filter_impulse_workspace {.cdecl, importc: "gsl_filter_impulse_alloc", dynlib: libgsl.}
proc gsl_filter_impulse_free*(w: ptr gsl_filter_impulse_workspace) {.cdecl, importc: "gsl_filter_impulse_free", dynlib: libgsl.}
proc gsl_filter_impulse*(endtype: gsl_filter_end_t; scale_type: gsl_filter_scale_t;    t: cdouble; x: ptr gsl_vector; y: ptr gsl_vector;    xmedian: ptr gsl_vector; xsigma: ptr gsl_vector;    noutlier: ptr csize_t; ioutlier: ptr gsl_vector_int;    w: ptr gsl_filter_impulse_workspace): cint {.cdecl, importc: "gsl_filter_impulse", dynlib: libgsl.}
