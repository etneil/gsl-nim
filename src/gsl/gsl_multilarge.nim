...
type
  ...
  gsl_multilarge_linear_type* {.bycopy.} = object
    name*: cstring
    alloc*: proc (p: csize_t): pointer {.cdecl.}
    reset*: proc (a1: pointer): cint {.cdecl.}
    accumulate*: proc (X: ptr gsl_matrix; y: ptr gsl_vector; a3: pointer): cint {.cdecl.}
    solve*: proc (lambda: cdouble; c: ptr gsl_vector; rnorm: ptr cdouble; snorm: ptr cdouble; a5: pointer): cint {.cdecl.}
    rcond*: proc (rcond: ptr cdouble; a2: pointer): cint {.cdecl.}
    lcurve*: proc (reg_param: ptr gsl_vector; rho: ptr gsl_vector; eta: ptr gsl_vector; a4: pointer): cint {.cdecl.}
    free*: proc (a1: pointer) {.cdecl.}

  gsl_multilarge_linear_workspace* {.bycopy.} = object
...
proc gsl_multilarge_linear_alloc*(T: ptr gsl_multilarge_linear_type; p: csize_t): ptr gsl_multilarge_linear_workspace {. cdecl, importc: "gsl_multilarge_linear_alloc", dynlib: libgsl.}
proc gsl_multilarge_linear_free*(w: ptr gsl_multilarge_linear_workspace) {.cdecl, importc: "gsl_multilarge_linear_free", dynlib: libgsl.}
proc gsl_multilarge_linear_name*(w: ptr gsl_multilarge_linear_workspace): cstring {. cdecl, importc: "gsl_multilarge_linear_name", dynlib: libgsl.}
proc gsl_multilarge_linear_reset*(w: ptr gsl_multilarge_linear_workspace): cint {. cdecl, importc: "gsl_multilarge_linear_reset", dynlib: libgsl.}
proc gsl_multilarge_linear_accumulate*(X: ptr gsl_matrix; y: ptr gsl_vector;   w: ptr gsl_multilarge_linear_workspace): cint {. cdecl, importc: "gsl_multilarge_linear_accumulate", dynlib: libgsl.}
proc gsl_multilarge_linear_solve*(lambda: cdouble; c: ptr gsl_vector; rnorm: ptr cdouble; snorm: ptr cdouble; w: ptr gsl_multilarge_linear_workspace): cint {. cdecl, importc: "gsl_multilarge_linear_solve", dynlib: libgsl.}
proc gsl_multilarge_linear_rcond*(rcond: ptr cdouble; w: ptr gsl_multilarge_linear_workspace): cint {. cdecl, importc: "gsl_multilarge_linear_rcond", dynlib: libgsl.}
proc gsl_multilarge_linear_lcurve*(reg_param: ptr gsl_vector; rho: ptr gsl_vector; eta: ptr gsl_vector; w: ptr gsl_multilarge_linear_workspace): cint {. cdecl, importc: "gsl_multilarge_linear_lcurve", dynlib: libgsl.}
proc gsl_multilarge_linear_wstdform1*(L: ptr gsl_vector; X: ptr gsl_matrix;  w: ptr gsl_vector; y: ptr gsl_vector;  Xs: ptr gsl_matrix; ys: ptr gsl_vector;  work: ptr gsl_multilarge_linear_workspace): cint {. cdecl, importc: "gsl_multilarge_linear_wstdform1", dynlib: libgsl.}
proc gsl_multilarge_linear_stdform1*(L: ptr gsl_vector; X: ptr gsl_matrix; y: ptr gsl_vector; Xs: ptr gsl_matrix; ys: ptr gsl_vector; work: ptr gsl_multilarge_linear_workspace): cint {. cdecl, importc: "gsl_multilarge_linear_stdform1", dynlib: libgsl.}
proc gsl_multilarge_linear_L_decomp*(L: ptr gsl_matrix; tau: ptr gsl_vector): cint {. cdecl, importc: "gsl_multilarge_linear_L_decomp", dynlib: libgsl.}
proc gsl_multilarge_linear_wstdform2*(LQR: ptr gsl_matrix; Ltau: ptr gsl_vector;  X: ptr gsl_matrix; w: ptr gsl_vector;  y: ptr gsl_vector; Xs: ptr gsl_matrix;  ys: ptr gsl_vector;  work: ptr gsl_multilarge_linear_workspace): cint {. cdecl, importc: "gsl_multilarge_linear_wstdform2", dynlib: libgsl.}
proc gsl_multilarge_linear_stdform2*(LQR: ptr gsl_matrix; Ltau: ptr gsl_vector; X: ptr gsl_matrix; y: ptr gsl_vector; Xs: ptr gsl_matrix; ys: ptr gsl_vector; work: ptr gsl_multilarge_linear_workspace): cint {. cdecl, importc: "gsl_multilarge_linear_stdform2", dynlib: libgsl.}
proc gsl_multilarge_linear_genform1*(L: ptr gsl_vector; cs: ptr gsl_vector; c: ptr gsl_vector; work: ptr gsl_multilarge_linear_workspace): cint {. cdecl, importc: "gsl_multilarge_linear_genform1", dynlib: libgsl.}
proc gsl_multilarge_linear_genform2*(LQR: ptr gsl_matrix; Ltau: ptr gsl_vector; cs: ptr gsl_vector; c: ptr gsl_vector; work: ptr gsl_multilarge_linear_workspace): cint {. cdecl, importc: "gsl_multilarge_linear_genform2", dynlib: libgsl.}
...
var gsl_multilarge_linear_normal* {.importc: "gsl_multilarge_linear_normal", dynlib: libgsl.}: ptr gsl_multilarge_linear_type

var gsl_multilarge_linear_tsqr* {.importc: "gsl_multilarge_linear_tsqr",  dynlib: libgsl.}: ptr gsl_multilarge_linear_type
