...
type
  ...
  INNER_C_UNION_gsl_spblas_expanded_2438* {.bycopy.} = object {.union.}
    work*: pointer
  ...
  gsl_spmatrix* {.bycopy.} = object
    ...
    ano_gsl_spblas_expanded_2441*: INNER_C_UNION_gsl_spblas_expanded_2438
    sptype*: csize_t
...
proc gsl_spblas_dgemv*(TransA: CBLAS_TRANSPOSE_t; alpha: cdouble;  A: ptr gsl_spmatrix; x: ptr gsl_vector; beta: cdouble;  y: ptr gsl_vector): cint {.cdecl, importc: "gsl_spblas_dgemv", dynlib: libgsl.}
proc gsl_spblas_dgemm*(alpha: cdouble; A: ptr gsl_spmatrix; B: ptr gsl_spmatrix;  C: ptr gsl_spmatrix): cint {.cdecl, importc: "gsl_spblas_dgemm", dynlib: libgsl.}
proc gsl_spblas_scatter*(A: ptr gsl_spmatrix; j: csize_t; alpha: cdouble;    w: ptr csize_t; x: ptr cdouble; mark: csize_t;    C: ptr gsl_spmatrix; nz: csize_t): csize_t {.cdecl, importc: "gsl_spblas_scatter", dynlib: libgsl.}
