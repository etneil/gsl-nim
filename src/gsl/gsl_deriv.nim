...
proc gsl_deriv_central*(f: ptr gsl_function; x: cdouble; h: cdouble;   result: ptr cdouble; abserr: ptr cdouble): cint {.cdecl, importc: "gsl_deriv_central", dynlib: libgsl.}
proc gsl_deriv_backward*(f: ptr gsl_function; x: cdouble; h: cdouble;    result: ptr cdouble; abserr: ptr cdouble): cint {.cdecl, importc: "gsl_deriv_backward", dynlib: libgsl.}
proc gsl_deriv_forward*(f: ptr gsl_function; x: cdouble; h: cdouble;   result: ptr cdouble; abserr: ptr cdouble): cint {.cdecl, importc: "gsl_deriv_forward", dynlib: libgsl.}
