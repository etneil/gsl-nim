...
proc gsl_permute_vector_complex_long_double*(p: ptr gsl_permutation; v: ptr gsl_vector_complex_long_double): cint {.cdecl, importc: "gsl_permute_vector_complex_long_double", dynlib: libgsl.}
proc gsl_permute_vector_complex_long_double_inverse*(p: ptr gsl_permutation; v: ptr gsl_vector_complex_long_double): cint {.cdecl, importc: "gsl_permute_vector_complex_long_double_inverse", dynlib: libgsl.}
...
proc gsl_permute_vector_complex*(p: ptr gsl_permutation; v: ptr gsl_vector_complex): cint {. cdecl, importc: "gsl_permute_vector_complex", dynlib: libgsl.}
proc gsl_permute_vector_complex_inverse*(p: ptr gsl_permutation; v: ptr gsl_vector_complex): cint {.cdecl, importc: "gsl_permute_vector_complex_inverse", dynlib: libgsl.}
...
proc gsl_permute_vector_complex_float*(p: ptr gsl_permutation;   v: ptr gsl_vector_complex_float): cint {. cdecl, importc: "gsl_permute_vector_complex_float", dynlib: libgsl.}
proc gsl_permute_vector_complex_float_inverse*(p: ptr gsl_permutation; v: ptr gsl_vector_complex_float): cint {.cdecl, importc: "gsl_permute_vector_complex_float_inverse", dynlib: libgsl.}
proc gsl_permute_vector_long_double*(p: ptr gsl_permutation; v: ptr gsl_vector_long_double): cint {.cdecl, importc: "gsl_permute_vector_long_double", dynlib: libgsl.}
proc gsl_permute_vector_long_double_inverse*(p: ptr gsl_permutation; v: ptr gsl_vector_long_double): cint {.cdecl, importc: "gsl_permute_vector_long_double_inverse", dynlib: libgsl.}
proc gsl_permute_vector*(p: ptr gsl_permutation; v: ptr gsl_vector): cint {.cdecl, importc: "gsl_permute_vector", dynlib: libgsl.}
proc gsl_permute_vector_inverse*(p: ptr gsl_permutation; v: ptr gsl_vector): cint {. cdecl, importc: "gsl_permute_vector_inverse", dynlib: libgsl.}
proc gsl_permute_vector_float*(p: ptr gsl_permutation; v: ptr gsl_vector_float): cint {. cdecl, importc: "gsl_permute_vector_float", dynlib: libgsl.}
proc gsl_permute_vector_float_inverse*(p: ptr gsl_permutation;   v: ptr gsl_vector_float): cint {.cdecl, importc: "gsl_permute_vector_float_inverse", dynlib: libgsl.}
...
proc gsl_permute_vector_ulong*(p: ptr gsl_permutation; v: ptr gsl_vector_ulong): cint {. cdecl, importc: "gsl_permute_vector_ulong", dynlib: libgsl.}
proc gsl_permute_vector_ulong_inverse*(p: ptr gsl_permutation;   v: ptr gsl_vector_ulong): cint {.cdecl, importc: "gsl_permute_vector_ulong_inverse", dynlib: libgsl.}
...
proc gsl_permute_vector_long*(p: ptr gsl_permutation; v: ptr gsl_vector_long): cint {. cdecl, importc: "gsl_permute_vector_long", dynlib: libgsl.}
proc gsl_permute_vector_long_inverse*(p: ptr gsl_permutation; v: ptr gsl_vector_long): cint {. cdecl, importc: "gsl_permute_vector_long_inverse", dynlib: libgsl.}
...
proc gsl_permute_vector_uint*(p: ptr gsl_permutation; v: ptr gsl_vector_uint): cint {. cdecl, importc: "gsl_permute_vector_uint", dynlib: libgsl.}
proc gsl_permute_vector_uint_inverse*(p: ptr gsl_permutation; v: ptr gsl_vector_uint): cint {. cdecl, importc: "gsl_permute_vector_uint_inverse", dynlib: libgsl.}
...
proc gsl_permute_vector_int*(p: ptr gsl_permutation; v: ptr gsl_vector_int): cint {. cdecl, importc: "gsl_permute_vector_int", dynlib: libgsl.}
proc gsl_permute_vector_int_inverse*(p: ptr gsl_permutation; v: ptr gsl_vector_int): cint {. cdecl, importc: "gsl_permute_vector_int_inverse", dynlib: libgsl.}
...
proc gsl_permute_vector_ushort*(p: ptr gsl_permutation; v: ptr gsl_vector_ushort): cint {. cdecl, importc: "gsl_permute_vector_ushort", dynlib: libgsl.}
proc gsl_permute_vector_ushort_inverse*(p: ptr gsl_permutation;    v: ptr gsl_vector_ushort): cint {.cdecl, importc: "gsl_permute_vector_ushort_inverse", dynlib: libgsl.}
...
proc gsl_permute_vector_short*(p: ptr gsl_permutation; v: ptr gsl_vector_short): cint {. cdecl, importc: "gsl_permute_vector_short", dynlib: libgsl.}
proc gsl_permute_vector_short_inverse*(p: ptr gsl_permutation;   v: ptr gsl_vector_short): cint {.cdecl, importc: "gsl_permute_vector_short_inverse", dynlib: libgsl.}
...
proc gsl_permute_vector_uchar*(p: ptr gsl_permutation; v: ptr gsl_vector_uchar): cint {. cdecl, importc: "gsl_permute_vector_uchar", dynlib: libgsl.}
proc gsl_permute_vector_uchar_inverse*(p: ptr gsl_permutation;   v: ptr gsl_vector_uchar): cint {.cdecl, importc: "gsl_permute_vector_uchar_inverse", dynlib: libgsl.}
...
proc gsl_permute_vector_char*(p: ptr gsl_permutation; v: ptr gsl_vector_char): cint {. cdecl, importc: "gsl_permute_vector_char", dynlib: libgsl.}
proc gsl_permute_vector_char_inverse*(p: ptr gsl_permutation; v: ptr gsl_vector_char): cint {. cdecl, importc: "gsl_permute_vector_char_inverse", dynlib: libgsl.}
