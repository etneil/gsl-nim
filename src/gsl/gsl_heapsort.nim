...
type
  ...
  gsl_comparison_fn_t* = proc (a1: pointer; a2: pointer): cint {.cdecl.}
...
proc gsl_heapsort*(array: pointer; count: csize_t; size: csize_t; compare: gsl_comparison_fn_t) {.cdecl, importc: "gsl_heapsort", dynlib: libgsl.}
proc gsl_heapsort_index*(p: ptr csize_t; array: pointer; count: csize_t; size: csize_t;    compare: gsl_comparison_fn_t): cint {.cdecl, importc: "gsl_heapsort_index", dynlib: libgsl.}
