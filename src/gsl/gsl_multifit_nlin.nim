...
type
  ...
  gsl_multifit_function_struct* {.bycopy.} = object
    f*: proc (x: ptr gsl_vector; params: pointer; f: ptr gsl_vector): cint {.cdecl.}
    n*: csize_t
    p*: csize_t
    params*: pointer

  gsl_multifit_function* = gsl_multifit_function_struct
  gsl_multifit_fsolver_type* {.bycopy.} = object
    name*: cstring
    size*: csize_t
    alloc*: proc (state: pointer; n: csize_t; p: csize_t): cint {.cdecl.}
    set*: proc (state: pointer; function: ptr gsl_multifit_function; x: ptr gsl_vector; f: ptr gsl_vector; dx: ptr gsl_vector): cint {.cdecl.}
    iterate*: proc (state: pointer; function: ptr gsl_multifit_function; x: ptr gsl_vector; f: ptr gsl_vector; dx: ptr gsl_vector): cint {.cdecl.}
    free*: proc (state: pointer) {.cdecl.}

  gsl_multifit_fsolver* {.bycopy.} = object
    `type`*: ptr gsl_multifit_fsolver_type
    function*: ptr gsl_multifit_function
    x*: ptr gsl_vector
    f*: ptr gsl_vector
    dx*: ptr gsl_vector
    state*: pointer

  gsl_multifit_function_fdf_struct* {.bycopy.} = object
    f*: proc (x: ptr gsl_vector; params: pointer; f: ptr gsl_vector): cint {.cdecl.}
    df*: proc (x: ptr gsl_vector; params: pointer; df: ptr gsl_matrix): cint {.cdecl.}
    fdf*: proc (x: ptr gsl_vector; params: pointer; f: ptr gsl_vector; df: ptr gsl_matrix): cint {.     cdecl.}
    n*: csize_t
    p*: csize_t
    params*: pointer
    nevalf*: csize_t
  ...
  gsl_multifit_fdfsolver_type* {.bycopy.} = object
    name*: cstring
    size*: csize_t
    alloc*: proc (state: pointer; n: csize_t; p: csize_t): cint {.cdecl.}
    set*: proc (state: pointer; wts: ptr gsl_vector; fdf: ptr gsl_multifit_function_fdf; x: ptr gsl_vector; f: ptr gsl_vector; dx: ptr gsl_vector): cint {.cdecl.}
    iterate*: proc (state: pointer; wts: ptr gsl_vector; fdf: ptr gsl_multifit_function_fdf; x: ptr gsl_vector; f: ptr gsl_vector; dx: ptr gsl_vector): cint {.cdecl.}
    gradient*: proc (state: pointer; g: ptr gsl_vector): cint {.cdecl.}
    jac*: proc (state: pointer; J: ptr gsl_matrix): cint {.cdecl.}
    free*: proc (state: pointer) {.cdecl.}

  gsl_multifit_fdfsolver* {.bycopy.} = object
  ...
  gsl_multifit_fdfridge* {.bycopy.} = object
    n*: csize_t
    p*: csize_t
    lambda*: cdouble
...
proc gsl_multifit_gradient*(J: ptr gsl_matrix; f: ptr gsl_vector; g: ptr gsl_vector): cint {. cdecl, importc: "gsl_multifit_gradient", dynlib: libgsl.}
proc gsl_multifit_covar*(J: ptr gsl_matrix; epsrel: cdouble; covar: ptr gsl_matrix): cint {. cdecl, importc: "gsl_multifit_covar", dynlib: libgsl.}
proc gsl_multifit_covar_QRPT*(r: ptr gsl_matrix; perm: ptr gsl_permutation;  epsrel: cdouble; covar: ptr gsl_matrix): cint {.cdecl, importc: "gsl_multifit_covar_QRPT", dynlib: libgsl.}
proc gsl_multifit_fsolver_alloc*(T: ptr gsl_multifit_fsolver_type; n: csize_t; p: csize_t): ptr gsl_multifit_fsolver {.cdecl, importc: "gsl_multifit_fsolver_alloc", dynlib: libgsl.}
proc gsl_multifit_fsolver_free*(s: ptr gsl_multifit_fsolver) {.cdecl, importc: "gsl_multifit_fsolver_free", dynlib: libgsl.}
proc gsl_multifit_fsolver_set*(s: ptr gsl_multifit_fsolver;   f: ptr gsl_multifit_function; x: ptr gsl_vector): cint {. cdecl, importc: "gsl_multifit_fsolver_set", dynlib: libgsl.}
proc gsl_multifit_fsolver_iterate*(s: ptr gsl_multifit_fsolver): cint {.cdecl, importc: "gsl_multifit_fsolver_iterate", dynlib: libgsl.}
proc gsl_multifit_fsolver_driver*(s: ptr gsl_multifit_fsolver; maxiter: csize_t; epsabs: cdouble; epsrel: cdouble): cint {.cdecl, importc: "gsl_multifit_fsolver_driver", dynlib: libgsl.}
proc gsl_multifit_fsolver_name*(s: ptr gsl_multifit_fsolver): cstring {.cdecl, importc: "gsl_multifit_fsolver_name", dynlib: libgsl.}
proc gsl_multifit_fsolver_position*(s: ptr gsl_multifit_fsolver): ptr gsl_vector {. cdecl, importc: "gsl_multifit_fsolver_position", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_alloc*(T: ptr gsl_multifit_fdfsolver_type; n: csize_t; p: csize_t): ptr gsl_multifit_fdfsolver {.cdecl, importc: "gsl_multifit_fdfsolver_alloc", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_set*(s: ptr gsl_multifit_fdfsolver; fdf: ptr gsl_multifit_function_fdf; x: ptr gsl_vector): cint {.cdecl, importc: "gsl_multifit_fdfsolver_set", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_wset*(s: ptr gsl_multifit_fdfsolver; f: ptr gsl_multifit_function_fdf; x: ptr gsl_vector; wts: ptr gsl_vector): cint {.cdecl, importc: "gsl_multifit_fdfsolver_wset", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_iterate*(s: ptr gsl_multifit_fdfsolver): cint {.cdecl, importc: "gsl_multifit_fdfsolver_iterate", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_driver*(s: ptr gsl_multifit_fdfsolver; maxiter: csize_t;  xtol: cdouble; gtol: cdouble; ftol: cdouble;  info: ptr cint): cint {.cdecl, importc: "gsl_multifit_fdfsolver_driver", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_jac*(s: ptr gsl_multifit_fdfsolver; J: ptr gsl_matrix): cint {. cdecl, importc: "gsl_multifit_fdfsolver_jac", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_free*(s: ptr gsl_multifit_fdfsolver) {.cdecl, importc: "gsl_multifit_fdfsolver_free", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_name*(s: ptr gsl_multifit_fdfsolver): cstring {.cdecl, importc: "gsl_multifit_fdfsolver_name", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_position*(s: ptr gsl_multifit_fdfsolver): ptr gsl_vector {. cdecl, importc: "gsl_multifit_fdfsolver_position", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_residual*(s: ptr gsl_multifit_fdfsolver): ptr gsl_vector {. cdecl, importc: "gsl_multifit_fdfsolver_residual", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_niter*(s: ptr gsl_multifit_fdfsolver): csize_t {.cdecl, importc: "gsl_multifit_fdfsolver_niter", dynlib: libgsl.}
proc gsl_multifit_eval_wf*(fdf: ptr gsl_multifit_function_fdf; x: ptr gsl_vector;  wts: ptr gsl_vector; y: ptr gsl_vector): cint {.cdecl, importc: "gsl_multifit_eval_wf", dynlib: libgsl.}
proc gsl_multifit_eval_wdf*(fdf: ptr gsl_multifit_function_fdf; x: ptr gsl_vector;   wts: ptr gsl_vector; dy: ptr gsl_matrix): cint {.cdecl, importc: "gsl_multifit_eval_wdf", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_test*(s: ptr gsl_multifit_fdfsolver; xtol: cdouble; gtol: cdouble; ftol: cdouble; info: ptr cint): cint {. cdecl, importc: "gsl_multifit_fdfsolver_test", dynlib: libgsl.}
proc gsl_multifit_test_delta*(dx: ptr gsl_vector; x: ptr gsl_vector; epsabs: cdouble;  epsrel: cdouble): cint {.cdecl, importc: "gsl_multifit_test_delta", dynlib: libgsl.}
proc gsl_multifit_test_gradient*(g: ptr gsl_vector; epsabs: cdouble): cint {.cdecl, importc: "gsl_multifit_test_gradient", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_dif_df*(x: ptr gsl_vector; wts: ptr gsl_vector;  fdf: ptr gsl_multifit_function_fdf;  f: ptr gsl_vector; J: ptr gsl_matrix): cint {.cdecl, importc: "gsl_multifit_fdfsolver_dif_df", dynlib: libgsl.}
proc gsl_multifit_fdfsolver_dif_fdf*(x: ptr gsl_vector; fdf: ptr gsl_multifit_function_fdf; f: ptr gsl_vector; J: ptr gsl_matrix): cint {. cdecl, importc: "gsl_multifit_fdfsolver_dif_fdf", dynlib: libgsl.}
proc gsl_multifit_fdfridge_alloc*(T: ptr gsl_multifit_fdfsolver_type; n: csize_t; p: csize_t): ptr gsl_multifit_fdfridge {.cdecl, importc: "gsl_multifit_fdfridge_alloc", dynlib: libgsl.}
proc gsl_multifit_fdfridge_free*(work: ptr gsl_multifit_fdfridge) {.cdecl, importc: "gsl_multifit_fdfridge_free", dynlib: libgsl.}
proc gsl_multifit_fdfridge_name*(w: ptr gsl_multifit_fdfridge): cstring {.cdecl, importc: "gsl_multifit_fdfridge_name", dynlib: libgsl.}
proc gsl_multifit_fdfridge_position*(w: ptr gsl_multifit_fdfridge): ptr gsl_vector {. cdecl, importc: "gsl_multifit_fdfridge_position", dynlib: libgsl.}
proc gsl_multifit_fdfridge_residual*(w: ptr gsl_multifit_fdfridge): ptr gsl_vector {. cdecl, importc: "gsl_multifit_fdfridge_residual", dynlib: libgsl.}
proc gsl_multifit_fdfridge_niter*(w: ptr gsl_multifit_fdfridge): csize_t {.cdecl, importc: "gsl_multifit_fdfridge_niter", dynlib: libgsl.}
proc gsl_multifit_fdfridge_set*(w: ptr gsl_multifit_fdfridge; f: ptr gsl_multifit_function_fdf; x: ptr gsl_vector; lambda: cdouble): cint {.cdecl, importc: "gsl_multifit_fdfridge_set", dynlib: libgsl.}
proc gsl_multifit_fdfridge_wset*(w: ptr gsl_multifit_fdfridge; f: ptr gsl_multifit_function_fdf; x: ptr gsl_vector; lambda: cdouble; wts: ptr gsl_vector): cint {.cdecl, importc: "gsl_multifit_fdfridge_wset", dynlib: libgsl.}
proc gsl_multifit_fdfridge_set2*(w: ptr gsl_multifit_fdfridge; f: ptr gsl_multifit_function_fdf; x: ptr gsl_vector; lambda: ptr gsl_vector): cint {. cdecl, importc: "gsl_multifit_fdfridge_set2", dynlib: libgsl.}
proc gsl_multifit_fdfridge_wset2*(w: ptr gsl_multifit_fdfridge; f: ptr gsl_multifit_function_fdf; x: ptr gsl_vector; lambda: ptr gsl_vector; wts: ptr gsl_vector): cint {.cdecl, importc: "gsl_multifit_fdfridge_wset2", dynlib: libgsl.}
proc gsl_multifit_fdfridge_set3*(w: ptr gsl_multifit_fdfridge; f: ptr gsl_multifit_function_fdf; x: ptr gsl_vector; L: ptr gsl_matrix): cint {.cdecl, importc: "gsl_multifit_fdfridge_set3", dynlib: libgsl.}
proc gsl_multifit_fdfridge_wset3*(w: ptr gsl_multifit_fdfridge; f: ptr gsl_multifit_function_fdf; x: ptr gsl_vector; L: ptr gsl_matrix; wts: ptr gsl_vector): cint {.cdecl, importc: "gsl_multifit_fdfridge_wset3", dynlib: libgsl.}
proc gsl_multifit_fdfridge_iterate*(w: ptr gsl_multifit_fdfridge): cint {.cdecl, importc: "gsl_multifit_fdfridge_iterate", dynlib: libgsl.}
proc gsl_multifit_fdfridge_driver*(w: ptr gsl_multifit_fdfridge; maxiter: csize_t; xtol: cdouble; gtol: cdouble; ftol: cdouble; info: ptr cint): cint {.cdecl, importc: "gsl_multifit_fdfridge_driver", dynlib: libgsl.}
...
var gsl_multifit_fdfsolver_lmsder* {.importc: "gsl_multifit_fdfsolver_lmsder",  dynlib: libgsl.}: ptr gsl_multifit_fdfsolver_type

var gsl_multifit_fdfsolver_lmder* {.importc: "gsl_multifit_fdfsolver_lmder", dynlib: libgsl.}: ptr gsl_multifit_fdfsolver_type

var gsl_multifit_fdfsolver_lmniel* {.importc: "gsl_multifit_fdfsolver_lmniel",  dynlib: libgsl.}: ptr gsl_multifit_fdfsolver_type
