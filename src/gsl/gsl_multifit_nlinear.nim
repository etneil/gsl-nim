...
type
  ...
  gsl_multifit_nlinear_fdtype* {.size: sizeof(cint).} = enum
    GSL_MULTIFIT_NLINEAR_FWDIFF, GSL_MULTIFIT_NLINEAR_CTRDIFF
  gsl_multifit_nlinear_fdf* {.bycopy.} = object
  ...
  gsl_multifit_nlinear_trs* {.bycopy.} = object
    name*: cstring
  ...
  gsl_multifit_nlinear_scale* {.bycopy.} = object
    name*: cstring
    init*: proc (J: ptr gsl_matrix; diag: ptr gsl_vector): cint {.cdecl.}
    update*: proc (J: ptr gsl_matrix; diag: ptr gsl_vector): cint {.cdecl.}

  gsl_multifit_nlinear_solver* {.bycopy.} = object
    name*: cstring
    alloc*: proc (n: csize_t; p: csize_t): pointer {.cdecl.}
    init*: proc (vtrust_state: pointer; vstate: pointer): cint {.cdecl.}
    presolve*: proc (mu: cdouble; vtrust_state: pointer; vstate: pointer): cint {.cdecl.}
    solve*: proc (f: ptr gsl_vector; x: ptr gsl_vector; vtrust_state: pointer; vstate: pointer): cint {.cdecl.}
    rcond*: proc (rcond: ptr cdouble; vstate: pointer): cint {.cdecl.}
    free*: proc (vstate: pointer) {.cdecl.}

  gsl_multifit_nlinear_parameters* {.bycopy.} = object
  ...
  gsl_multifit_nlinear_type* {.bycopy.} = object
    name*: cstring
    alloc*: proc (params: ptr gsl_multifit_nlinear_parameters; n: csize_t; p: csize_t): pointer {.     cdecl.}
    init*: proc (state: pointer; wts: ptr gsl_vector; fdf: ptr gsl_multifit_nlinear_fdf; x: ptr gsl_vector; f: ptr gsl_vector; J: ptr gsl_matrix; g: ptr gsl_vector): cint {.cdecl.}
    iterate*: proc (state: pointer; wts: ptr gsl_vector; fdf: ptr gsl_multifit_nlinear_fdf; x: ptr gsl_vector; f: ptr gsl_vector; J: ptr gsl_matrix; g: ptr gsl_vector; dx: ptr gsl_vector): cint {.cdecl.}
    rcond*: proc (rcond: ptr cdouble; state: pointer): cint {.cdecl.}
    avratio*: proc (state: pointer): cdouble {.cdecl.}
    free*: proc (state: pointer) {.cdecl.}

  gsl_multifit_nlinear_trust_state* {.bycopy.} = object
    x*: ptr gsl_vector
    f*: ptr gsl_vector
    g*: ptr gsl_vector
    J*: ptr gsl_matrix
  ...
  gsl_multifit_nlinear_workspace* {.bycopy.} = object
...
proc gsl_multifit_nlinear_alloc*(T: ptr gsl_multifit_nlinear_type; params: ptr gsl_multifit_nlinear_parameters; n: csize_t; p: csize_t): ptr gsl_multifit_nlinear_workspace {. cdecl, importc: "gsl_multifit_nlinear_alloc", dynlib: libgsl.}
proc gsl_multifit_nlinear_free*(w: ptr gsl_multifit_nlinear_workspace) {.cdecl, importc: "gsl_multifit_nlinear_free", dynlib: libgsl.}
proc gsl_multifit_nlinear_default_parameters*(): gsl_multifit_nlinear_parameters {. cdecl, importc: "gsl_multifit_nlinear_default_parameters", dynlib: libgsl.}
proc gsl_multifit_nlinear_init*(x: ptr gsl_vector; fdf: ptr gsl_multifit_nlinear_fdf; w: ptr gsl_multifit_nlinear_workspace): cint {.cdecl, importc: "gsl_multifit_nlinear_init", dynlib: libgsl.}
proc gsl_multifit_nlinear_winit*(x: ptr gsl_vector; wts: ptr gsl_vector; fdf: ptr gsl_multifit_nlinear_fdf; w: ptr gsl_multifit_nlinear_workspace): cint {. cdecl, importc: "gsl_multifit_nlinear_winit", dynlib: libgsl.}
proc gsl_multifit_nlinear_iterate*(w: ptr gsl_multifit_nlinear_workspace): cint {. cdecl, importc: "gsl_multifit_nlinear_iterate", dynlib: libgsl.}
proc gsl_multifit_nlinear_avratio*(w: ptr gsl_multifit_nlinear_workspace): cdouble {. cdecl, importc: "gsl_multifit_nlinear_avratio", dynlib: libgsl.}
proc gsl_multifit_nlinear_driver*(maxiter: csize_t; xtol: cdouble; gtol: cdouble; ftol: cdouble; callback: proc (iter: csize_t; params: pointer; w: ptr gsl_multifit_nlinear_workspace) {.cdecl.}; callback_params: pointer; info: ptr cint; w: ptr gsl_multifit_nlinear_workspace): cint {. cdecl, importc: "gsl_multifit_nlinear_driver", dynlib: libgsl.}
proc gsl_multifit_nlinear_jac*(w: ptr gsl_multifit_nlinear_workspace): ptr gsl_matrix {. cdecl, importc: "gsl_multifit_nlinear_jac", dynlib: libgsl.}
proc gsl_multifit_nlinear_name*(w: ptr gsl_multifit_nlinear_workspace): cstring {. cdecl, importc: "gsl_multifit_nlinear_name", dynlib: libgsl.}
proc gsl_multifit_nlinear_position*(w: ptr gsl_multifit_nlinear_workspace): ptr gsl_vector {. cdecl, importc: "gsl_multifit_nlinear_position", dynlib: libgsl.}
proc gsl_multifit_nlinear_residual*(w: ptr gsl_multifit_nlinear_workspace): ptr gsl_vector {. cdecl, importc: "gsl_multifit_nlinear_residual", dynlib: libgsl.}
proc gsl_multifit_nlinear_niter*(w: ptr gsl_multifit_nlinear_workspace): csize_t {. cdecl, importc: "gsl_multifit_nlinear_niter", dynlib: libgsl.}
proc gsl_multifit_nlinear_rcond*(rcond: ptr cdouble; w: ptr gsl_multifit_nlinear_workspace): cint {. cdecl, importc: "gsl_multifit_nlinear_rcond", dynlib: libgsl.}
proc gsl_multifit_nlinear_trs_name*(w: ptr gsl_multifit_nlinear_workspace): cstring {. cdecl, importc: "gsl_multifit_nlinear_trs_name", dynlib: libgsl.}
proc gsl_multifit_nlinear_eval_f*(fdf: ptr gsl_multifit_nlinear_fdf; x: ptr gsl_vector; swts: ptr gsl_vector; y: ptr gsl_vector): cint {.cdecl, importc: "gsl_multifit_nlinear_eval_f", dynlib: libgsl.}
proc gsl_multifit_nlinear_eval_df*(x: ptr gsl_vector; f: ptr gsl_vector; swts: ptr gsl_vector; h: cdouble; fdtype: gsl_multifit_nlinear_fdtype; fdf: ptr gsl_multifit_nlinear_fdf; df: ptr gsl_matrix; work: ptr gsl_vector): cint {. cdecl, importc: "gsl_multifit_nlinear_eval_df", dynlib: libgsl.}
proc gsl_multifit_nlinear_eval_fvv*(h: cdouble; x: ptr gsl_vector; v: ptr gsl_vector;  f: ptr gsl_vector; J: ptr gsl_matrix;  swts: ptr gsl_vector;  fdf: ptr gsl_multifit_nlinear_fdf;  yvv: ptr gsl_vector; work: ptr gsl_vector): cint {. cdecl, importc: "gsl_multifit_nlinear_eval_fvv", dynlib: libgsl.}
proc gsl_multifit_nlinear_covar*(J: ptr gsl_matrix; epsrel: cdouble; covar: ptr gsl_matrix): cint {.cdecl, importc: "gsl_multifit_nlinear_covar", dynlib: libgsl.}
proc gsl_multifit_nlinear_test*(xtol: cdouble; gtol: cdouble; ftol: cdouble; info: ptr cint; w: ptr gsl_multifit_nlinear_workspace): cint {.cdecl, importc: "gsl_multifit_nlinear_test", dynlib: libgsl.}
proc gsl_multifit_nlinear_df*(h: cdouble; fdtype: gsl_multifit_nlinear_fdtype;  x: ptr gsl_vector; wts: ptr gsl_vector;  fdf: ptr gsl_multifit_nlinear_fdf; f: ptr gsl_vector;  J: ptr gsl_matrix; work: ptr gsl_vector): cint {.cdecl, importc: "gsl_multifit_nlinear_df", dynlib: libgsl.}
proc gsl_multifit_nlinear_fdfvv*(h: cdouble; x: ptr gsl_vector; v: ptr gsl_vector; f: ptr gsl_vector; J: ptr gsl_matrix; swts: ptr gsl_vector; fdf: ptr gsl_multifit_nlinear_fdf; fvv: ptr gsl_vector; work: ptr gsl_vector): cint {. cdecl, importc: "gsl_multifit_nlinear_fdfvv", dynlib: libgsl.}
...
var gsl_multifit_nlinear_trust* {.importc: "gsl_multifit_nlinear_trust",  dynlib: libgsl.}: ptr gsl_multifit_nlinear_type

var gsl_multifit_nlinear_trs_lm* {.importc: "gsl_multifit_nlinear_trs_lm",   dynlib: libgsl.}: ptr gsl_multifit_nlinear_trs

var gsl_multifit_nlinear_trs_lmaccel* {.importc: "gsl_multifit_nlinear_trs_lmaccel",   dynlib: libgsl.}: ptr gsl_multifit_nlinear_trs

var gsl_multifit_nlinear_trs_dogleg* {.importc: "gsl_multifit_nlinear_trs_dogleg",  dynlib: libgsl.}: ptr gsl_multifit_nlinear_trs

var gsl_multifit_nlinear_trs_ddogleg* {.importc: "gsl_multifit_nlinear_trs_ddogleg",   dynlib: libgsl.}: ptr gsl_multifit_nlinear_trs

var gsl_multifit_nlinear_trs_subspace2D* {. importc: "gsl_multifit_nlinear_trs_subspace2D", dynlib: libgsl.}: ptr gsl_multifit_nlinear_trs

var gsl_multifit_nlinear_scale_levenberg* {. importc: "gsl_multifit_nlinear_scale_levenberg", dynlib: libgsl.}: ptr gsl_multifit_nlinear_scale

var gsl_multifit_nlinear_scale_marquardt* {. importc: "gsl_multifit_nlinear_scale_marquardt", dynlib: libgsl.}: ptr gsl_multifit_nlinear_scale

var gsl_multifit_nlinear_scale_more* {.importc: "gsl_multifit_nlinear_scale_more",  dynlib: libgsl.}: ptr gsl_multifit_nlinear_scale

var gsl_multifit_nlinear_solver_cholesky* {. importc: "gsl_multifit_nlinear_solver_cholesky", dynlib: libgsl.}: ptr gsl_multifit_nlinear_solver

var gsl_multifit_nlinear_solver_qr* {.importc: "gsl_multifit_nlinear_solver_qr", dynlib: libgsl.}: ptr gsl_multifit_nlinear_solver

var gsl_multifit_nlinear_solver_svd* {.importc: "gsl_multifit_nlinear_solver_svd",  dynlib: libgsl.}: ptr gsl_multifit_nlinear_solver
