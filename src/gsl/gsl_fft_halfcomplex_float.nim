...
type
  ...
  gsl_fft_halfcomplex_wavetable_float* {.bycopy.} = object
    n*: csize_t
    nf*: csize_t
    factor*: array[64, csize_t]
    twiddle*: array[64, ptr gsl_complex_float]
...
proc gsl_fft_halfcomplex_float_radix2_backward*(data: ptr cfloat; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_halfcomplex_float_radix2_backward", dynlib: libgsl.}
proc gsl_fft_halfcomplex_float_radix2_inverse*(data: ptr cfloat; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_halfcomplex_float_radix2_inverse", dynlib: libgsl.}
proc gsl_fft_halfcomplex_float_radix2_transform*(data: ptr cfloat; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_halfcomplex_float_radix2_transform", dynlib: libgsl.}
proc gsl_fft_halfcomplex_wavetable_float_alloc*(n: csize_t): ptr gsl_fft_halfcomplex_wavetable_float {. cdecl, importc: "gsl_fft_halfcomplex_wavetable_float_alloc", dynlib: libgsl.}
proc gsl_fft_halfcomplex_wavetable_float_free*(wavetable: ptr gsl_fft_halfcomplex_wavetable_float) {.cdecl, importc: "gsl_fft_halfcomplex_wavetable_float_free", dynlib: libgsl.}
proc gsl_fft_halfcomplex_float_backward*(data: ptr cfloat; stride: csize_t; n: csize_t; wavetable: ptr gsl_fft_halfcomplex_wavetable_float; work: ptr gsl_fft_real_workspace_float): cint {. cdecl, importc: "gsl_fft_halfcomplex_float_backward", dynlib: libgsl.}
proc gsl_fft_halfcomplex_float_inverse*(data: ptr cfloat; stride: csize_t; n: csize_t; wavetable: ptr gsl_fft_halfcomplex_wavetable_float;    work: ptr gsl_fft_real_workspace_float): cint {. cdecl, importc: "gsl_fft_halfcomplex_float_inverse", dynlib: libgsl.}
proc gsl_fft_halfcomplex_float_transform*(data: ptr cfloat; stride: csize_t; n: csize_t; wavetable: ptr gsl_fft_halfcomplex_wavetable_float; work: ptr gsl_fft_real_workspace_float): cint {.cdecl, importc: "gsl_fft_halfcomplex_float_transform", dynlib: libgsl.}
proc gsl_fft_halfcomplex_float_unpack*(halfcomplex_coefficient: ptr cfloat;   complex_coefficient: ptr cfloat;   stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_halfcomplex_float_unpack", dynlib: libgsl.}
proc gsl_fft_halfcomplex_float_radix2_unpack*(halfcomplex_coefficient: ptr cfloat; complex_coefficient: ptr cfloat; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_halfcomplex_float_radix2_unpack", dynlib: libgsl.}
