...
type
  ...
  gsl_fft_real_wavetable* {.bycopy.} = object
    n*: csize_t
    nf*: csize_t
  ...
  gsl_fft_real_workspace* {.bycopy.} = object
    n*: csize_t
    scratch*: ptr cdouble

  gsl_fft_halfcomplex_wavetable* {.bycopy.} = object
    n*: csize_t
    nf*: csize_t
    factor*: array[64, csize_t]
    twiddle*: array[64, ptr gsl_complex]
...
proc gsl_fft_real_radix2_transform*(data: ptr cdouble; stride: csize_t; n: csize_t): cint {. cdecl, importc: "gsl_fft_real_radix2_transform", dynlib: libgsl.}
proc gsl_fft_real_wavetable_alloc*(n: csize_t): ptr gsl_fft_real_wavetable {.cdecl, importc: "gsl_fft_real_wavetable_alloc", dynlib: libgsl.}
proc gsl_fft_real_wavetable_free*(wavetable: ptr gsl_fft_real_wavetable) {.cdecl, importc: "gsl_fft_real_wavetable_free", dynlib: libgsl.}
proc gsl_fft_real_workspace_alloc*(n: csize_t): ptr gsl_fft_real_workspace {.cdecl, importc: "gsl_fft_real_workspace_alloc", dynlib: libgsl.}
proc gsl_fft_real_workspace_free*(workspace: ptr gsl_fft_real_workspace) {.cdecl, importc: "gsl_fft_real_workspace_free", dynlib: libgsl.}
proc gsl_fft_real_transform*(data: ptr cdouble; stride: csize_t; n: csize_t; wavetable: ptr gsl_fft_real_wavetable; work: ptr gsl_fft_real_workspace): cint {.cdecl, importc: "gsl_fft_real_transform", dynlib: libgsl.}
proc gsl_fft_real_unpack*(real_coefficient: ptr cdouble; complex_coefficient: ptr cdouble; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_real_unpack", dynlib: libgsl.}
proc gsl_fft_halfcomplex_radix2_backward*(data: ptr cdouble; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_halfcomplex_radix2_backward", dynlib: libgsl.}
proc gsl_fft_halfcomplex_radix2_inverse*(data: ptr cdouble; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_halfcomplex_radix2_inverse", dynlib: libgsl.}
proc gsl_fft_halfcomplex_radix2_transform*(data: ptr cdouble; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_halfcomplex_radix2_transform", dynlib: libgsl.}
proc gsl_fft_halfcomplex_wavetable_alloc*(n: csize_t): ptr gsl_fft_halfcomplex_wavetable {. cdecl, importc: "gsl_fft_halfcomplex_wavetable_alloc", dynlib: libgsl.}
proc gsl_fft_halfcomplex_wavetable_free*(wavetable: ptr gsl_fft_halfcomplex_wavetable) {. cdecl, importc: "gsl_fft_halfcomplex_wavetable_free", dynlib: libgsl.}
proc gsl_fft_halfcomplex_backward*(data: ptr cdouble; stride: csize_t; n: csize_t; wavetable: ptr gsl_fft_halfcomplex_wavetable; work: ptr gsl_fft_real_workspace): cint {.cdecl, importc: "gsl_fft_halfcomplex_backward", dynlib: libgsl.}
proc gsl_fft_halfcomplex_inverse*(data: ptr cdouble; stride: csize_t; n: csize_t; wavetable: ptr gsl_fft_halfcomplex_wavetable; work: ptr gsl_fft_real_workspace): cint {.cdecl, importc: "gsl_fft_halfcomplex_inverse", dynlib: libgsl.}
proc gsl_fft_halfcomplex_transform*(data: ptr cdouble; stride: csize_t; n: csize_t; wavetable: ptr gsl_fft_halfcomplex_wavetable; work: ptr gsl_fft_real_workspace): cint {. cdecl, importc: "gsl_fft_halfcomplex_transform", dynlib: libgsl.}
proc gsl_fft_halfcomplex_unpack*(halfcomplex_coefficient: ptr cdouble; complex_coefficient: ptr cdouble; stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_halfcomplex_unpack", dynlib: libgsl.}
proc gsl_fft_halfcomplex_radix2_unpack*(halfcomplex_coefficient: ptr cdouble;    complex_coefficient: ptr cdouble;    stride: csize_t; n: csize_t): cint {.cdecl, importc: "gsl_fft_halfcomplex_radix2_unpack", dynlib: libgsl.}
