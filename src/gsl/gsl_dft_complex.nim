...
proc gsl_dft_complex_forward*(data: ptr cdouble; stride: csize_t; n: csize_t;  result: ptr cdouble): cint {.cdecl, importc: "gsl_dft_complex_forward", dynlib: libgsl.}
proc gsl_dft_complex_backward*(data: ptr cdouble; stride: csize_t; n: csize_t;   result: ptr cdouble): cint {.cdecl, importc: "gsl_dft_complex_backward", dynlib: libgsl.}
proc gsl_dft_complex_inverse*(data: ptr cdouble; stride: csize_t; n: csize_t;  result: ptr cdouble): cint {.cdecl, importc: "gsl_dft_complex_inverse", dynlib: libgsl.}
proc gsl_dft_complex_transform*(data: ptr cdouble; stride: csize_t; n: csize_t; result: ptr cdouble; sign: gsl_fft_direction): cint {. cdecl, importc: "gsl_dft_complex_transform", dynlib: libgsl.}
