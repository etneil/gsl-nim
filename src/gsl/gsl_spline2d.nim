...
proc gsl_spline2d_alloc*(T: ptr gsl_interp2d_type; xsize: csize_t; ysize: csize_t): ptr gsl_spline2d {. cdecl, importc: "gsl_spline2d_alloc", dynlib: libgsl.}
proc gsl_spline2d_init*(interp: ptr gsl_spline2d; xa: ptr cdouble; ya: ptr cdouble;   za: ptr cdouble; xsize: csize_t; ysize: csize_t): cint {.cdecl, importc: "gsl_spline2d_init", dynlib: libgsl.}
proc gsl_spline2d_free*(interp: ptr gsl_spline2d) {.cdecl, importc: "gsl_spline2d_free", dynlib: libgsl.}
proc gsl_spline2d_eval*(interp: ptr gsl_spline2d; x: cdouble; y: cdouble;   xa: ptr gsl_interp_accel; ya: ptr gsl_interp_accel): cdouble {. cdecl, importc: "gsl_spline2d_eval", dynlib: libgsl.}
proc gsl_spline2d_eval_e*(interp: ptr gsl_spline2d; x: cdouble; y: cdouble; xa: ptr gsl_interp_accel; ya: ptr gsl_interp_accel; z: ptr cdouble): cint {.cdecl, importc: "gsl_spline2d_eval_e", dynlib: libgsl.}
proc gsl_spline2d_eval_deriv_x*(interp: ptr gsl_spline2d; x: cdouble; y: cdouble; xa: ptr gsl_interp_accel; ya: ptr gsl_interp_accel): cdouble {. cdecl, importc: "gsl_spline2d_eval_deriv_x", dynlib: libgsl.}
proc gsl_spline2d_eval_deriv_x_e*(interp: ptr gsl_spline2d; x: cdouble; y: cdouble; xa: ptr gsl_interp_accel; ya: ptr gsl_interp_accel; z: ptr cdouble): cint {. cdecl, importc: "gsl_spline2d_eval_deriv_x_e", dynlib: libgsl.}
proc gsl_spline2d_eval_deriv_y*(interp: ptr gsl_spline2d; x: cdouble; y: cdouble; xa: ptr gsl_interp_accel; ya: ptr gsl_interp_accel): cdouble {. cdecl, importc: "gsl_spline2d_eval_deriv_y", dynlib: libgsl.}
proc gsl_spline2d_eval_deriv_y_e*(interp: ptr gsl_spline2d; x: cdouble; y: cdouble; xa: ptr gsl_interp_accel; ya: ptr gsl_interp_accel; z: ptr cdouble): cint {. cdecl, importc: "gsl_spline2d_eval_deriv_y_e", dynlib: libgsl.}
proc gsl_spline2d_eval_deriv_xx*(interp: ptr gsl_spline2d; x: cdouble; y: cdouble; xa: ptr gsl_interp_accel; ya: ptr gsl_interp_accel): cdouble {. cdecl, importc: "gsl_spline2d_eval_deriv_xx", dynlib: libgsl.}
proc gsl_spline2d_eval_deriv_xx_e*(interp: ptr gsl_spline2d; x: cdouble; y: cdouble; xa: ptr gsl_interp_accel; ya: ptr gsl_interp_accel; z: ptr cdouble): cint {. cdecl, importc: "gsl_spline2d_eval_deriv_xx_e", dynlib: libgsl.}
proc gsl_spline2d_eval_deriv_yy*(interp: ptr gsl_spline2d; x: cdouble; y: cdouble; xa: ptr gsl_interp_accel; ya: ptr gsl_interp_accel): cdouble {. cdecl, importc: "gsl_spline2d_eval_deriv_yy", dynlib: libgsl.}
proc gsl_spline2d_eval_deriv_yy_e*(interp: ptr gsl_spline2d; x: cdouble; y: cdouble; xa: ptr gsl_interp_accel; ya: ptr gsl_interp_accel; z: ptr cdouble): cint {. cdecl, importc: "gsl_spline2d_eval_deriv_yy_e", dynlib: libgsl.}
proc gsl_spline2d_eval_deriv_xy*(interp: ptr gsl_spline2d; x: cdouble; y: cdouble; xa: ptr gsl_interp_accel; ya: ptr gsl_interp_accel): cdouble {. cdecl, importc: "gsl_spline2d_eval_deriv_xy", dynlib: libgsl.}
proc gsl_spline2d_eval_deriv_xy_e*(interp: ptr gsl_spline2d; x: cdouble; y: cdouble; xa: ptr gsl_interp_accel; ya: ptr gsl_interp_accel; z: ptr cdouble): cint {. cdecl, importc: "gsl_spline2d_eval_deriv_xy_e", dynlib: libgsl.}
proc gsl_spline2d_min_size*(interp: ptr gsl_spline2d): csize_t {.cdecl, importc: "gsl_spline2d_min_size", dynlib: libgsl.}
proc gsl_spline2d_name*(interp: ptr gsl_spline2d): cstring {.cdecl, importc: "gsl_spline2d_name", dynlib: libgsl.}
proc gsl_spline2d_set*(interp: ptr gsl_spline2d; zarr: ptr cdouble; i: csize_t;  j: csize_t; z: cdouble): cint {.cdecl, importc: "gsl_spline2d_set", dynlib: libgsl.}
proc gsl_spline2d_get*(interp: ptr gsl_spline2d; zarr: ptr cdouble; i: csize_t;  j: csize_t): cdouble {.cdecl, importc: "gsl_spline2d_get", dynlib: libgsl.}
