...
type
  ...
  gsl_bspline_workspace* {.bycopy.} = object
    k*: csize_t
    km1*: csize_t
    l*: csize_t
    nbreak*: csize_t
...
proc gsl_bspline_alloc*(k: csize_t; nbreak: csize_t): ptr gsl_bspline_workspace {. cdecl, importc: "gsl_bspline_alloc", dynlib: libgsl.}
proc gsl_bspline_free*(w: ptr gsl_bspline_workspace) {.cdecl, importc: "gsl_bspline_free", dynlib: libgsl.}
proc gsl_bspline_ncoeffs*(w: ptr gsl_bspline_workspace): csize_t {.cdecl, importc: "gsl_bspline_ncoeffs", dynlib: libgsl.}
proc gsl_bspline_order*(w: ptr gsl_bspline_workspace): csize_t {.cdecl, importc: "gsl_bspline_order", dynlib: libgsl.}
proc gsl_bspline_nbreak*(w: ptr gsl_bspline_workspace): csize_t {.cdecl, importc: "gsl_bspline_nbreak", dynlib: libgsl.}
proc gsl_bspline_breakpoint*(i: csize_t; w: ptr gsl_bspline_workspace): cdouble {. cdecl, importc: "gsl_bspline_breakpoint", dynlib: libgsl.}
proc gsl_bspline_greville_abscissa*(i: csize_t; w: ptr gsl_bspline_workspace): cdouble {. cdecl, importc: "gsl_bspline_greville_abscissa", dynlib: libgsl.}
proc gsl_bspline_knots*(breakpts: ptr gsl_vector; w: ptr gsl_bspline_workspace): cint {. cdecl, importc: "gsl_bspline_knots", dynlib: libgsl.}
proc gsl_bspline_knots_uniform*(a: cdouble; b: cdouble; w: ptr gsl_bspline_workspace): cint {. cdecl, importc: "gsl_bspline_knots_uniform", dynlib: libgsl.}
proc gsl_bspline_knots_greville*(abscissae: ptr gsl_vector; w: ptr gsl_bspline_workspace; abserr: ptr cdouble): cint {. cdecl, importc: "gsl_bspline_knots_greville", dynlib: libgsl.}
proc gsl_bspline_eval*(x: cdouble; B: ptr gsl_vector; w: ptr gsl_bspline_workspace): cint {. cdecl, importc: "gsl_bspline_eval", dynlib: libgsl.}
proc gsl_bspline_eval_nonzero*(x: cdouble; Bk: ptr gsl_vector; istart: ptr csize_t;   iend: ptr csize_t; w: ptr gsl_bspline_workspace): cint {. cdecl, importc: "gsl_bspline_eval_nonzero", dynlib: libgsl.}
proc gsl_bspline_deriv_eval*(x: cdouble; nderiv: csize_t; dB: ptr gsl_matrix; w: ptr gsl_bspline_workspace): cint {.cdecl, importc: "gsl_bspline_deriv_eval", dynlib: libgsl.}
proc gsl_bspline_deriv_eval_nonzero*(x: cdouble; nderiv: csize_t; dB: ptr gsl_matrix; istart: ptr csize_t; iend: ptr csize_t; w: ptr gsl_bspline_workspace): cint {.cdecl, importc: "gsl_bspline_deriv_eval_nonzero", dynlib: libgsl.}
