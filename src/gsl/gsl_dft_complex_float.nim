...
proc gsl_dft_complex_float_forward*(data: ptr cfloat; stride: csize_t; n: csize_t;  result: ptr cfloat): cint {.cdecl, importc: "gsl_dft_complex_float_forward", dynlib: libgsl.}
proc gsl_dft_complex_float_backward*(data: ptr cfloat; stride: csize_t; n: csize_t; result: ptr cfloat): cint {.cdecl, importc: "gsl_dft_complex_float_backward", dynlib: libgsl.}
proc gsl_dft_complex_float_inverse*(data: ptr cfloat; stride: csize_t; n: csize_t;  result: ptr cfloat): cint {.cdecl, importc: "gsl_dft_complex_float_inverse", dynlib: libgsl.}
proc gsl_dft_complex_float_transform*(data: ptr cfloat; stride: csize_t; n: csize_t;  result: ptr cfloat; sign: gsl_fft_direction): cint {. cdecl, importc: "gsl_dft_complex_float_transform", dynlib: libgsl.}
